...
| --- | --- | --- | --- | --- |
| `V101-001` | Source Agent Entry v1 Alignment | P0 | v1.0.0 release audit | planned |
| `V101-002` | Release Tag Event Certification Gate | P0 | V101-001 | planned |
| `V101-003` | Release Provenance Manifest | P0 | V101-002 | planned |
| `V101-004` | Clean-room Cargo Test Reproducibility | P0 | none | planned |
| `V101-005` | Public Delivery Audit Sidecar Policy | P1 | V101-002, V101-003 | planned |
| `V101-006` | Provider Smoke Optional Proof Artifact | P1 | V101-002 | planned |
| `V101-007` | Message Bus No-go ADR | P1 | none | planned |
| `V101-008` | Software Dev Pack Usage Baseline | P1 | V101-003, V101-005, V101-006 | planned |
| `V101-009` | Trusted Governance Telemetry Source | P0 | V101-006 | planned |
| `V101-010` | v1.0.1 Release Certification | P0 | V101-001, V101-002, V101-003, V101-004, V101-005, V101-006, V101-007, V101-008, V101-009 | planned |

## V101-001 Source Agent Entry v1 Alignment

### Scope

把 release source 中的 Agent entry 完整对齐到 `v1.0.0` / `v1.0.1`。

必须处理：

- 根目录 `AGENTS.md` 不再指向 `docs/v0.9.1/README.md` 作为当前稳定入口；
- `docs/architecture/040-release-source-agent-entry-v1.md` 更新 current stabilization 文档口径；
- release gate 的 source-agent-entry 检查覆盖 `docs/v1.0.0/README.md` 和 v1 release certification 文档；
