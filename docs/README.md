...
| `v0.8.1/` | v0.8.1 Pack System 发布后修复任务基线 |
...
13. [requirements/README.md](requirements/README.md)
14. [requirements/next-requirements.md](requirements/next-requirements.md)
15. [product/README.md](product/README.md)
16. [product/design-system.md](product/design-system.md)
17. [foundation/README.md](foundation/README.md)
18. [architecture/README.md](architecture/README.md)
19. [verification/058h-release-gate-e2e-v1.md](verification/058h-release-gate-e2e-v1.md)
20. [verification/064-v0-3-1-release-gate-certification-v1.md](verification/064-v0-3-1-release-gate-certification-v1.md)
21. [verification/history.md](verification/history.md)
...
- `v0.8.1/` 下文档记录 `v0.8.0` 发布后的 Pack System 修复任务；重点是 file-backed Pack source、registry-driven resolver、Pack-specific Projection、capability-aware availability、negative fixtures 和 release certification。
