...
fn main() {
    tauri::Builder::default()
        .invoke_handler(tauri::generate_handler![
            ...
            commands::goal_tree::create_goal_tree_goal,
            commands::goal_tree::update_goal_tree_goal,
            commands::goal_tree::archive_goal_tree_goal,
            commands::goal_tree::create_goal_tree_milestone,
            commands::goal_tree::update_goal_tree_milestone,
            commands::goal_tree::archive_goal_tree_milestone,
            commands::goal_tree::create_goal_tree_issue,
            commands::goal_tree::update_goal_tree_issue,
            commands::goal_tree::archive_goal_tree_issue,
            commands::goal_tree::reorder_goal_tree,
            commands::goal_tree::validate_goal_tree,
            commands::goal_tree::prepare_goal_tree_issue_context,
