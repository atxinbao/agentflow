...
mod tests {
    ...
    #[test]
    fn desktop_commands_read_execute_completed_workflow_state() {
        let ready = agentflow_workflow_acceptance::prepare_execution_completed_fixture().unwrap();
        ...
        assert_eq!(gates.current_stage, WorkflowStage::ExecuteCompleted);
        ...
        assert_eq!(refreshed.current_stage, WorkflowStage::ExecuteCompleted);
