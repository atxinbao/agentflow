export type AgentFlowProjectPage = "home" | "tasks" | "files" | "delivery" | "audit" | "advanced";
...
const projectPages: AgentFlowProjectPage[] = ["home", "tasks", "files", "delivery", "audit", "advanced"];
