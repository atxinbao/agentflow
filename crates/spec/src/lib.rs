...
pub use model::{
    ...
    ProjectBrainSnapshot, ProjectBrainStatus, PublicDeliveryRecord, RequirementBoundaryBlocker,
    RequirementBoundarySummary, RequirementBoundaryVerdict, RequirementClassificationResult,
    RequirementConfirmationGate, RequirementContextDocumentRef, RequirementContextFactState,
...
pub use storage::{
    ...
    list_spec_issues, list_spec_loop_stage_artifacts, list_spec_projects,
    materialize_spec_from_requirement_preview, prepare_spec_workspace, project_from_requirement,
    read_completion_decision_runtime, read_project_brain_document_set, read_project_brain_snapshot,
    read_requirement_preview_runtime, read_spec_issue, read_spec_loop_requirement_manifest,
    read_spec_loop_stage_artifact, read_spec_project, record_completion_decision,
