...
pub use model::{
    ...
    ProjectBrainSnapshot, ProjectBrainStatus, PublicDeliveryRecord,
    RequirementClassificationResult, RequirementDocument, RequirementExecutionPermission,
    RequirementFactImpact, RequirementIntakeResult, RequirementIntentType,
    RequirementPreviewLifecycle, RequirementPreviewRuntime, RequirementRiskLevel,
    RequirementTargetObject, SpecArtifactAuthority, SpecExpectedOutputs, SpecIssue,
