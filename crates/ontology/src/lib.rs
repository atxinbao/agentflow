...
pub use evidence::{
    ...
    capture_core_evidence_receipt_for_local_file, core_evidence_authority_trace_negative_fixtures,
    ...
    core_evidence_source_type_registry_contract, core_missing_evidence_negative_fixtures,
    core_missing_evidence_report_for_pack, core_missing_evidence_reports_for_completeness_policy,
    evaluate_core_evidence_completeness_policy, external_core_evidence_reference_receipt,
    validate_core_evidence_authority_trace, validate_core_evidence_capture_receipt,
    ...
    CoreEvidenceSubjectRef, CoreEvidenceTraceRefs, CoreMissingEvidenceNegativeFixtureResult,
    CoreMissingEvidenceReport, CORE_EVIDENCE_AUTHORITY_TRACE_VERSION,
    CORE_EVIDENCE_CAPTURE_RECEIPT_VERSION, CORE_EVIDENCE_COMPLETENESS_POLICY_VERSION,
    CORE_EVIDENCE_PACK_SCHEMA_VERSION, CORE_EVIDENCE_SOURCE_TYPE_REGISTRY_VERSION,
    CORE_MISSING_EVIDENCE_REPORT_VERSION,
};
