...
pub use evidence::{
    ...
    core_evidence_capture_receipt_negative_fixtures, core_evidence_pack_negative_fixtures,
    core_evidence_source_type_registry_contract, external_core_evidence_reference_receipt,
    ...
    CoreEvidenceCollectionEventLink, CoreEvidenceDigest, CoreEvidencePack,
    ...
    CoreEvidenceSubjectRef, CoreEvidenceTraceRefs, CORE_EVIDENCE_AUTHORITY_TRACE_VERSION,
    CORE_EVIDENCE_CAPTURE_RECEIPT_VERSION, CORE_EVIDENCE_PACK_SCHEMA_VERSION,
    CORE_EVIDENCE_SOURCE_TYPE_REGISTRY_VERSION,
};
