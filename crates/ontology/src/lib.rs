...
pub use decision::{
    ...
    canonical_core_evidence_to_decision_gate_result_fixture, core_decision_failure_reason_contract,
    ...
    core_evidence_to_decision_gate_contract, evaluate_core_evidence_to_decision_gate,
    validate_core_decision_failure_reason, validate_core_decision_failure_reason_contract,
    validate_core_decision_input_binding, validate_core_decision_input_binding_contract,
    validate_core_decision_model_contract, validate_core_decision_outcome_transition_contract,
    validate_core_decision_record, validate_core_decision_transition_attempt,
    validate_core_evidence_decision_reference_model_contract,
    validate_core_evidence_to_decision_gate_contract,
    validate_core_evidence_to_decision_gate_result, CoreDecisionBoundAuthorityRef,
