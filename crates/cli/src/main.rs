            ...
            GovernancePolicyCommand::Evaluate {
                ...
                let report = agentflow_governance_policy::evaluate_runtime_governance(
                    ...
                    agentflow_governance_policy::GovernancePolicyRequest {
                        skill_ref: Some(format!("core:{role}:{action_type}")),
                        actor_role: role,
                        action_type,
                        generic_action: None,
                        object_type,
                        source_surface: Some("cli".to_string()),
                        tool_scopes: Vec::new(),
                        connector_scopes: Vec::new(),
                        evidence_refs: vec!["EvidenceRef:governance-cli-evidence".to_string()],
                        artifact_refs: vec!["ArtifactRef:governance-cli-artifact".to_string()],
