...
pub fn core_action_contract_bundle() -> ActionContractBundle {
    let action_types = vec![
        ...
        action_type(
            ...
            None,
            "Claim Issue",
            "Reserve issue execution ownership before code changes start.",
        ),
        action_type(
            "writePatch",
            ActionCategory::Execution,
            ...
            Some("Artifact"),
            "Write Patch",
            "Record the intended code patch for the current run.",
        ),
        action_type(
            "runValidation",
            ...
            Some("Evidence"),
            "Run Validation",
            "Attach validation evidence for the current run.",
        ),
        action_type(
            "prepareDelivery",
            ...
            Some("Artifact"),
            "Prepare Delivery",
            "Prepare the delivery package for closeout.",
        ),
        action_type(
            "submitEvidence",
            ActionCategory::Evidence,
        ...
        contract(
            ...
            input_schema(
                vec![field(
                    ...
                    ActionFieldValueType::String,
                    true,
                    "Why this issue is being claimed for work.",
                )],
                false,
            ),
            vec![precondition(
            ...
            vec![],
            vec![expected_event("IssueClaimed", Some("Issue"))],
            vec![],
        ),
        contract(
            "writePatch",
            ...
            vec![effect(
                "patch-artifact-recorded",
                ActionEffectKind::AttachArtifact,
                "Record patch artifact without closing the run.",
                Some("Artifact"),
                None,
                Some("run.state-machine"),
                Some("PatchWritten"),
            ...
            vec![required_evidence(
                ...
                1,
                AcceptedRefKind::ArtifactRef,
                "Patch artifact reference is required.",
            )],
            vec![expected_event("PatchWritten", Some("Artifact"))],
            vec!["produces"],
        ),
        contract(
            "runValidation",
            ...
            vec![effect(
                ...
                "Record validation evidence without closing the run.",
                Some("Evidence"),
                None,
                Some("run.state-machine"),
                Some("ValidationExecuted"),
            )],
            vec![required_evidence(
                "verificationLog",
                1,
                AcceptedRefKind::EvidenceRef,
                "Validation log reference is required.",
            )],
            vec![expected_event("ValidationExecuted", Some("Evidence"))],
            vec!["supports", "proves"],
        ),
        contract(
            "prepareDelivery",
            ...
            input_schema(
                vec![field(
                    ...
                    ActionFieldValueType::String,
                    true,
                    "Summary of the delivery artifact.",
                )],
                false,
            ),
            vec![precondition(
            ...
            vec![effect(
                "delivery-artifact-recorded",
                ActionEffectKind::AttachArtifact,
                "Prepare delivery artifact and close the run.",
                Some("Artifact"),
                None,
                Some("run.state-machine"),
                Some("DeliveryPrepared"),
            )],
            vec![required_evidence(
                "artifactSummary",
                1,
                AcceptedRefKind::ArtifactRef,
                "Delivery artifact reference is required.",
            )],
            vec![expected_event("DeliveryPrepared", Some("Artifact"))],
            vec!["produces"],
        ),
        contract(
            "submitEvidence",
