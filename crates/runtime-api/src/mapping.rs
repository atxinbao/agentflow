...
fn canonical_action_type(command_type: &str) -> Option<&'static str> {
    match command_type.trim() {
        ...
        "createIssue" | "createFollowUp" => Some("createIssue"),
        "activateIssue" => Some("activateIssue"),
        "claimIssue" => Some("claimIssue"),
        "startRun" => Some("startRun"),
        "writePatch" => Some("writePatch"),
        "runValidation" => Some("runValidation"),
        "prepareDelivery" => Some("prepareDelivery"),
        "submitEvidence" => Some("submitEvidence"),
        "submitArtifact" | "submitDelivery" => Some("submitArtifact"),
        "markIssueDone" | "acceptDelivery" => Some("markIssueDone"),
        "recordDecision" | "requestFix" | "reopenIssue" => Some("recordDecision"),
