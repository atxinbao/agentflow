...
pub use commercial::{
    admit_paid_report_runtime_proposal, build_commercial_product_read_model,
    build_paid_report_artifact, build_paid_report_input_snapshot, build_paid_report_order_intent,
    ...
    capture_paid_report_generation_evidence, commercial_golden_path,
    ...
    default_commercial_registry_root, evaluate_commercial_product, evaluate_paid_report_preflight,
    ...
    CommercialCommandPolicy, CommercialDeliveryPromise, CommercialEntitlementFixture,
    ...
    CommercialProjectionQuery, ManagedProjectCommercialFixture, PaidReportArtifact,
    PaidReportArtifactSection, PaidReportDecisionOutcome, PaidReportDecisionRecord,
    PaidReportDeliveryPackageProjection, PaidReportDeliveryProjection, PaidReportEvidencePack,
    PaidReportFeedbackLoopProjection, PaidReportInputSnapshot, PaidReportOrderIntent,
    ...
    MANAGED_PROJECT_COMMERCIAL_FIXTURE_VERSION, PAID_REPORT_ARTIFACT_VERSION,
    PAID_REPORT_DECISION_RECORD_VERSION, PAID_REPORT_DELIVERY_PACKAGE_PROJECTION_VERSION,
    PAID_REPORT_DELIVERY_PROJECTION_VERSION, PAID_REPORT_EVIDENCE_PACK_VERSION,
    PAID_REPORT_FEEDBACK_LOOP_PROJECTION_VERSION, PAID_REPORT_INPUT_SNAPSHOT_VERSION,
    PAID_REPORT_ORDER_INTENT_VERSION, PAID_REPORT_PREFLIGHT_VERSION,
