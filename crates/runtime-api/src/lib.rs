...
pub use commercial::{
    ...
    capture_paid_report_generation_evidence, commercial_backend_stable_contract,
    commercial_golden_path, commercial_golden_path_from_registry,
    commercial_negative_fixture_report, decide_paid_report_delivery,
    ...
    PaidReportRuntimeProposalHandoff, COMMERCIAL_BACKEND_STABLE_CONTRACT_VERSION,
