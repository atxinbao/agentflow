...
V112_REAL_PRODUCT_RUNTIME_PROOF_PATH="$RUNTIME_DIR/v112-real-product-runtime-proof.json"
V112_REAL_PRODUCT_PROJECTION_PROOF_PATH="$RUNTIME_DIR/v112-real-product-projection-proof.json"
V112_PRODUCT_BRIDGE_POLLUTION_SCAN_PATH="$RUNTIME_DIR/v112-product-bridge-pollution-scan.json"
V112_REGISTRY_DISCOVERED_SECOND_PRODUCT_PATH="$RUNTIME_DIR/v112-registry-discovered-second-product.json"
V112_DESKTOP_PRODUCT_COMMAND_ROUTE_READ_MODEL_PATH="$RUNTIME_DIR/v112-desktop-product-command-route-read-model.json"
V112_DESKTOP_COMMAND_BUTTON_INSTALLATION_PATH="$RUNTIME_DIR/v112-desktop-command-button-installation.json"
V112_MULTI_PRODUCT_CONSOLE_STATES_PATH="$RUNTIME_DIR/v112-multi-product-console-states.json"
V112_RELEASE_CERTIFICATION_PATH="$RUNTIME_DIR/v112-release-certification.json"
V113_PRODUCT_COMMAND_STATE_CONTRACT_PATH="$RUNTIME_DIR/v113-product-command-state-contract.json"
V113_PRODUCT_COMMAND_SUBMIT_CONTRACT_PATH="$RUNTIME_DIR/v113-product-command-submit-contract.json"
V113_RUNTIME_PRODUCT_COMMAND_SUBMIT_API_PATH="$RUNTIME_DIR/v113-runtime-product-command-submit-api.json"
V113_DESKTOP_CONFIRM_SUBMIT_COMMAND_FLOW_PATH="$RUNTIME_DIR/v113-desktop-confirm-submit-command-flow.json"
V113_PRODUCT_COMMAND_EVIDENCE_HANDOFF_PATH="$RUNTIME_DIR/v113-product-command-evidence-handoff.json"
V113_MULTI_PRODUCT_STATE_UI_PROOF_PATH="$RUNTIME_DIR/v113-multi-product-state-ui-proof.json"
V113_SEMANTIC_PRODUCT_BRIDGE_POLLUTION_SCAN_PATH="$RUNTIME_DIR/v113-semantic-product-bridge-pollution-scan.json"
V113_RELEASE_CERTIFICATION_PATH="$RUNTIME_DIR/v113-release-certification.json"
V114_PRODUCT_SUBMIT_RECEIPT_BINDING_PATH="$RUNTIME_DIR/v114-product-submit-receipt-binding.json"
V114_DESKTOP_CONFIRM_SUBMIT_INTERACTION_PATH="$RUNTIME_DIR/v114-desktop-confirm-submit-interaction.json"
V114_PRODUCT_BRIDGE_SEMANTIC_POLLUTION_SCAN_PATH="$RUNTIME_DIR/v114-product-bridge-semantic-pollution-scan.json"
V114_PROJECT_WORKSPACE_CREATION_CONTRACT_PATH="$RUNTIME_DIR/v114-project-workspace-creation-contract.json"
V114_PRODUCT_SELECTED_WORKSPACE_BOOTSTRAP_PATH="$RUNTIME_DIR/v114-product-selected-workspace-bootstrap.json"
V114_STANDARD_DOCS_AGENTFLOW_FACT_SOURCE_INIT_PATH="$RUNTIME_DIR/v114-standard-docs-agentflow-fact-source-init.json"
V114_ACTIVE_PRODUCT_WORKSPACE_PROJECTION_PATH="$RUNTIME_DIR/v114-active-product-workspace-projection.json"
V114_WORKSPACE_INIT_FAILURE_RECOVERY_PATH="$RUNTIME_DIR/v114-workspace-init-failure-recovery.json"
V114_SOFTWARE_DEV_WORKSPACE_GOLDEN_PATH_PATH="$RUNTIME_DIR/v114-software-dev-workspace-golden-path.json"
V114_RELEASE_CERTIFICATION_PATH="$RUNTIME_DIR/v114-release-certification.json"
V115_NEXT_RELEASE_PLANNING_ALIGNMENT_PATH="$RUNTIME_DIR/v115-next-release-planning-alignment.json"
V115_PRODUCT_WORKSPACE_DESKTOP_ENTRY_BRIDGE_PATH="$RUNTIME_DIR/v115-product-workspace-desktop-entry-bridge.json"
V115_PORTABLE_WORKSPACE_RECEIPT_PROJECTION_PATHS_PATH="$RUNTIME_DIR/v115-portable-workspace-receipt-projection-paths.json"
V115_INTENT_INTAKE_CONTRACT_PATH="$RUNTIME_DIR/v115-intent-intake-contract.json"
V115_CORE_ROUTE_POLICY_PATH="$RUNTIME_DIR/v115-core-route-policy.json"
V115_SPEC_BUNDLE_GOAL_ROADMAP_TASK_DERIVATION_PATH="$RUNTIME_DIR/v115-spec-bundle-goal-roadmap-task-derivation.json"
V115_CONFIRMATION_GATE_AUTHORITY_BOUNDARY_PATH="$RUNTIME_DIR/v115-confirmation-gate-authority-boundary.json"
V115_SPEC_MATERIALIZER_DOCS_AGENTFLOW_AUTHORITY_PATH="$RUNTIME_DIR/v115-spec-materializer-docs-agentflow-authority.json"
V115_SOFTWARE_DEV_SPEC_TO_TASKS_GOLDEN_PATH_PATH="$RUNTIME_DIR/v115-software-dev-spec-to-tasks-golden-path.json"
V115_RELEASE_CERTIFICATION_PATH="$RUNTIME_DIR/v115-release-certification.json"
V116_NEXT_RELEASE_AUTHORITY_ALIGNMENT_PATH="$RUNTIME_DIR/v116-next-release-authority-alignment.json"
V116_CORE_ROUTE_NEXT_ACTION_SEMANTICS_PATH="$RUNTIME_DIR/v116-core-route-next-action-semantics.json"
V116_PRODUCT_SPEC_INTAKE_DESKTOP_INVOCATION_BRIDGE_PATH="$RUNTIME_DIR/v116-product-spec-intake-desktop-invocation-bridge.json"
V116_EXECUTOR_ADAPTER_HANDOFF_PACKAGE_PATH="$RUNTIME_DIR/v116-executor-adapter-handoff-package.json"
V116_ALLOWED_SURFACE_DIFF_BOUNDARY_CHECK_PATH="$RUNTIME_DIR/v116-allowed-surface-diff-boundary-check.json"
V116_EXECUTOR_EVIDENCE_CAPTURE_PATH="$RUNTIME_DIR/v116-executor-evidence-capture.json"
V116_EXECUTOR_RESULT_ISSUE_RUN_WRITEBACK_PATH="$RUNTIME_DIR/v116-executor-result-issue-run-writeback.json"
V116_FAILURE_TIMEOUT_CANCEL_RETRY_SEMANTICS_PATH="$RUNTIME_DIR/v116-failure-timeout-cancel-retry-semantics.json"
V116_SOFTWARE_DEV_REAL_EXECUTOR_GOLDEN_PATH_PATH="$RUNTIME_DIR/v116-software-dev-real-executor-golden-path.json"
V116_RELEASE_CERTIFICATION_PATH="$RUNTIME_DIR/v116-release-certification.json"
V117_NEXT_RELEASE_PLANNING_SURFACE_CONTRACT_PATH="$RUNTIME_DIR/v117-next-release-planning-surface-contract.json"
V117_EXECUTOR_SURFACE_PATH_VALIDATION_HARDENING_PATH="$RUNTIME_DIR/v117-executor-surface-path-validation-hardening.json"
V117_DESKTOP_EXECUTOR_FLOW_READ_MODEL_PATH="$RUNTIME_DIR/v117-desktop-executor-flow-read-model.json"
V117_EVIDENCE_GRAPH_USER_READABLE_PROJECTION_PATH="$RUNTIME_DIR/v117-evidence-graph-user-readable-projection.json"
V117_DECISION_REASON_REMEDIATION_PROJECTION_PATH="$RUNTIME_DIR/v117-decision-reason-remediation-projection.json"
V117_DELIVERY_PACKAGE_READABILITY_CONTRACT_PATH="$RUNTIME_DIR/v117-delivery-package-readability-contract.json"
V117_FAILURE_NEEDS_FIX_DEFERRED_REPAIR_PATHS_PATH="$RUNTIME_DIR/v117-failure-needs-fix-deferred-repair-paths.json"
V117_PORTABLE_LOCAL_DIAGNOSTIC_BOUNDARY_PATH="$RUNTIME_DIR/v117-portable-local-diagnostic-boundary.json"
V117_RELEASE_CERTIFICATION_SCHEMA_HARDENING_PATH="$RUNTIME_DIR/v117-release-certification-schema-hardening.json"
V117_RELEASE_CERTIFICATION_PATH="$RUNTIME_DIR/v117-release-certification.json"
V118_RELEASE_CLOSEOUT_CERTIFICATION_METADATA_HARDENING_PATH="$RUNTIME_DIR/v118-release-closeout-certification-metadata-hardening.json"
V118_EVIDENCE_GRAPH_COMPLETION_PROOF_TIGHTENING_PATH="$RUNTIME_DIR/v118-evidence-graph-completion-proof-tightening.json"
V118_DESKTOP_EXECUTOR_FLOW_FRONTEND_INVOCATION_PATH="$RUNTIME_DIR/v118-desktop-executor-flow-frontend-invocation.json"
V118_RUN_RESUME_CONTRACT_PATH="$RUNTIME_DIR/v118-run-resume-contract.json"
V118_FAILED_COMMAND_RECOVERY_PATH="$RUNTIME_DIR/v118-failed-command-recovery.json"
V118_INTERRUPTED_EXECUTOR_SESSION_CLOSEOUT_PATH="$RUNTIME_DIR/v118-interrupted-executor-session-closeout.json"
V118_DUPLICATE_COMMAND_IDEMPOTENCY_HANDLING_PATH="$RUNTIME_DIR/v118-duplicate-command-idempotency-handling.json"
V118_STALE_PROJECTION_REBUILD_RECOVERY_PATH="$RUNTIME_DIR/v118-stale-projection-rebuild-recovery.json"
V118_WORKSPACE_HEALTH_CHECK_PATH="$RUNTIME_DIR/v118-workspace-health-check.json"
V118_RELEASE_CERTIFICATION_PATH="$RUNTIME_DIR/v118-release-certification.json"
V119_RELEASE_CERTIFICATION_METADATA_TOP_LEVEL_CONTRACT_PATH="$RUNTIME_DIR/v119-release-certification-metadata-top-level-contract.json"
V119_RECOVERY_IDEMPOTENCY_RECEIPT_PATH_HARDENING_PATH="$RUNTIME_DIR/v119-recovery-idempotency-receipt-path-hardening.json"
V119_PROJECTION_REBUILD_POSITIVE_RECOVERY_PROOF_PATH="$RUNTIME_DIR/v119-projection-rebuild-positive-recovery-proof.json"
V119_WORKSPACE_HEALTH_PROVIDER_SKILL_SMOKE_BOUNDARY_PATH="$RUNTIME_DIR/v119-workspace-health-provider-skill-smoke-boundary.json"
V119_SOFTWARE_DEV_REFERENCE_APP_BETA_SCOPE_ALIGNMENT_PATH="$RUNTIME_DIR/v119-software-dev-reference-app-beta-scope-alignment.json"
V119_E2E_PROJECT_INTAKE_TASKS_GOLDEN_SCENARIO_PATH="$RUNTIME_DIR/v119-e2e-project-intake-tasks-golden-scenario.json"
V119_EXECUTOR_RUN_EVIDENCE_DECISION_DELIVERY_GOLDEN_PATH="$RUNTIME_DIR/v119-executor-run-evidence-decision-delivery-golden-path.json"
V119_FAILURE_RETRY_FEEDBACK_BETA_SCENARIO_PATH="$RUNTIME_DIR/v119-failure-retry-feedback-beta-scenario.json"
V119_DESKTOP_BETA_READINESS_UI_SMOKE_PROOF_PATH="$RUNTIME_DIR/v119-desktop-beta-readiness-ui-smoke-proof.json"
V119_BETA_RELEASE_CERTIFICATION_PATH="$RUNTIME_DIR/v119-beta-release-certification.json"
V120_RELEASE_CERTIFICATION_TOP_LEVEL_METADATA_PATH="$RUNTIME_DIR/v120-release-certification-top-level-metadata.json"
V120_CERTIFICATION_ARTIFACT_MANIFEST_PRIMARY_PROOF_INDEX_PATH="$RUNTIME_DIR/v120-certification-artifact-manifest-primary-proof-index.json"
V120_FIRST_RUN_PRODUCT_ONBOARDING_CONTRACT_PATH="$RUNTIME_DIR/v120-first-run-product-onboarding-contract.json"
V120_PRODUCT_SELECTION_WORKSPACE_BOOTSTRAP_PATH="$RUNTIME_DIR/v120-product-selection-workspace-bootstrap.json"
V120_WORKSPACE_READINESS_PREFLIGHT_PATH="$RUNTIME_DIR/v120-workspace-readiness-preflight.json"
V120_PROVIDER_CONNECTOR_SKILL_READINESS_PATH="$RUNTIME_DIR/v120-provider-connector-skill-readiness.json"
V120_GUIDED_SAMPLE_PROJECT_GOLDEN_RUN_PATH="$RUNTIME_DIR/v120-guided-sample-project-golden-run.json"
...
V123_RELEASE_CERTIFICATION_PATH="$RUNTIME_DIR/v123-release-certification.json"
V124_LIVE_CLOSEOUT_DISTINCTION_PATH="$RUNTIME_DIR/v124-live-closeout-distinction.json"
V124_FINAL_CLOSEOUT_CERTIFICATION_PATH="$RUNTIME_DIR/v124-final-closeout-certification.json"
V124_COMMERCIAL_PRODUCT_READ_MODEL_RUNTIME_API_PATH="$RUNTIME_DIR/v124-commercial-product-read-model-runtime-api.json"
V124_COMMERCIAL_PRODUCT_PROJECTION_QUERY_PATH="$RUNTIME_DIR/v124-commercial-product-projection-query.json"
V124_PAID_REPORT_PREFLIGHT_RUNTIME_API_PATH="$RUNTIME_DIR/v124-paid-report-preflight-runtime-api.json"
V124_MANAGED_PROJECT_COMMERCIAL_RUNTIME_FIXTURE_PATH="$RUNTIME_DIR/v124-managed-project-commercial-runtime-fixture.json"
V124_COMMERCIAL_NEGATIVE_RUNTIME_FIXTURES_PATH="$RUNTIME_DIR/v124-commercial-negative-runtime-fixtures.json"
V124_COMMERCIAL_GOLDEN_PATH_PATH="$RUNTIME_DIR/v124-commercial-golden-path.json"
V124_RELEASE_CERTIFICATION_PATH="$RUNTIME_DIR/v124-release-certification.json"
V125_RELEASE_PUBLICATION_STATE_PATH="$RUNTIME_DIR/v125-release-publication-state.json"
V125_CERTIFICATION_SPLIT_PATH="$RUNTIME_DIR/v125-candidate-published-certification-split.json"
V125_WAIVER_CONTRACT_CONSISTENCY_PATH="$RUNTIME_DIR/v125-waiver-contract-consistency.json"
V125_PRODUCT_REGISTRY_READ_MODEL_PATH="$RUNTIME_DIR/v125-product-registry-commercial-read-model.json"
V125_ENTITLEMENT_SOURCE_FIXTURE_PATH="$RUNTIME_DIR/v125-entitlement-source-fixture.json"
V125_PAID_REPORT_PRODUCT_DEFINITION_PATH="$RUNTIME_DIR/v125-paid-report-product-definition.json"
V125_DESKTOP_RUNTIME_ONLY_COMMERCIAL_SURFACE_PATH="$RUNTIME_DIR/v125-desktop-runtime-only-commercial-surface.json"
...
V127_NEXT_RELEASE_PLANNING_ALIGNMENT_PATH="$RUNTIME_DIR/v127-next-release-planning-alignment.json"
V127_PRODUCT_FLOW_SOURCE_BOUNDARY_PATH="$RUNTIME_DIR/v127-product-flow-source-boundary.json"
V127_PROJECT_PAID_REPORT_INSTANCE_RESOLVER_PATH="$RUNTIME_DIR/v127-project-paid-report-instance-resolver.json"
V127_PROJECT_PAID_REPORT_PREFLIGHT_HANDOFF_API_PATH="$RUNTIME_DIR/v127-project-paid-report-preflight-handoff-api.json"
V127_DESKTOP_PAID_REPORT_PROJECT_ROOT_BRIDGE_PATH="$RUNTIME_DIR/v127-desktop-paid-report-project-root-bridge.json"
V127_GOLDEN_PATH_SOURCE_SEMANTICS_PATH="$RUNTIME_DIR/v127-golden-path-source-semantics.json"
V127_RUNTIME_PROPOSAL_ADMISSION_RECEIPT_PATH="$RUNTIME_DIR/v127-runtime-proposal-admission-receipt.json"
V127_PAID_REPORT_RUN_CONTRACT_BOUNDARY_PATH="$RUNTIME_DIR/v127-paid-report-run-contract-boundary.json"
V127_PAID_REPORT_DELIVERY_PROJECTION_CONTRACT_PATH="$RUNTIME_DIR/v127-paid-report-evidence-decision-delivery-projection-contract.json"
V127_RELEASE_CERTIFICATION_PATH="$RUNTIME_DIR/v127-release-certification.json"
V128_RELEASE_PROVENANCE_TAG_POLICY_REPAIR_PATH="$RUNTIME_DIR/v128-release-provenance-tag-policy-repair.json"
V128_PROJECT_UNIQUE_PRODUCT_INSTANCE_IDENTITY_PATH="$RUNTIME_DIR/v128-project-unique-product-instance-identity.json"
V128_PAID_REPORT_INPUT_SNAPSHOT_ORDER_INTENT_PATH="$RUNTIME_DIR/v128-paid-report-input-snapshot-order-intent-contract.json"
V128_PAID_REPORT_RUN_EXECUTION_RECEIPT_PATH="$RUNTIME_DIR/v128-paid-report-run-execution-receipt.json"
V128_REPORT_ARTIFACT_SCHEMA_STORAGE_BOUNDARY_PATH="$RUNTIME_DIR/v128-report-artifact-schema-storage-boundary.json"
V128_REPORT_GENERATION_EVIDENCE_CAPTURE_PATH="$RUNTIME_DIR/v128-report-generation-evidence-capture.json"
V128_DECISION_GATE_REPORT_DELIVERY_PATH="$RUNTIME_DIR/v128-decision-gate-report-delivery.json"
V128_DELIVERY_PACKAGE_PROJECTION_DOWNLOAD_CONTRACT_PATH="$RUNTIME_DIR/v128-delivery-package-projection-download-contract.json"
V128_FEEDBACK_REPAIR_REQUEST_LOOP_PATH="$RUNTIME_DIR/v128-feedback-repair-request-loop.json"
V128_RELEASE_CERTIFICATION_PATH="$RUNTIME_DIR/v128-release-certification.json"
V129_RELEASE_PROVENANCE_FACTS_ALIGNMENT_PATH="$RUNTIME_DIR/v129-release-provenance-facts-commit-alignment.json"
V129_ANNOTATED_TAG_KIND_CERTIFICATION_PATH="$RUNTIME_DIR/v129-annotated-tag-kind-certification-repair.json"
V129_PAID_REPORT_ORDER_RECORD_PATH="$RUNTIME_DIR/v129-paid-report-order-record-contract.json"
V129_PAYMENT_ENTITLEMENT_AUTHORIZATION_PATH="$RUNTIME_DIR/v129-payment-entitlement-authorization-boundary.json"
V129_ORDER_TO_RUN_ADMISSION_PATH="$RUNTIME_DIR/v129-order-to-run-admission-gate.json"
V129_CUSTOMER_DELIVERY_ACCESS_PATH="$RUNTIME_DIR/v129-customer-delivery-access-projection.json"
V129_REPORT_DOWNLOAD_TOKEN_ACCESS_RECEIPT_PATH="$RUNTIME_DIR/v129-report-download-token-access-receipt.json"
V129_REFUND_REPAIR_RERUN_POLICY_PATH="$RUNTIME_DIR/v129-refund-repair-rerun-policy-contract.json"
...
proof_chain = [
    ...
    {"stage": "release.v123-release-certification", "label": "V123 Release Certification"},
    {"stage": "release.v124-live-closeout-distinction", "label": "V124 Live Closeout Distinction"},
    {"stage": "release.v124-final-closeout-certification", "label": "V124 Final Closeout Certification"},
    {"stage": "release.v124-commercial-runtime-proofs", "label": "V124 Commercial Runtime Proofs"},
    {"stage": "release.v124-release-certification", "label": "V124 Release Certification"},
...
runtime_artifacts = [
    ...
    {"path": "runtime/v123-release-certification.json", "exists": pathlib.Path(summary_json_path.parent / "runtime/v123-release-certification.json").is_file()},
    {"path": "runtime/v124-live-closeout-distinction.json", "exists": pathlib.Path(summary_json_path.parent / "runtime/v124-live-closeout-distinction.json").is_file()},
    {"path": "runtime/v124-final-closeout-certification.json", "exists": pathlib.Path(summary_json_path.parent / "runtime/v124-final-closeout-certification.json").is_file()},
    {"path": "runtime/v124-commercial-product-read-model-runtime-api.json", "exists": pathlib.Path(summary_json_path.parent / "runtime/v124-commercial-product-read-model-runtime-api.json").is_file()},
    {"path": "runtime/v124-commercial-product-projection-query.json", "exists": pathlib.Path(summary_json_path.parent / "runtime/v124-commercial-product-projection-query.json").is_file()},
    {"path": "runtime/v124-paid-report-preflight-runtime-api.json", "exists": pathlib.Path(summary_json_path.parent / "runtime/v124-paid-report-preflight-runtime-api.json").is_file()},
    {"path": "runtime/v124-managed-project-commercial-runtime-fixture.json", "exists": pathlib.Path(summary_json_path.parent / "runtime/v124-managed-project-commercial-runtime-fixture.json").is_file()},
    {"path": "runtime/v124-commercial-negative-runtime-fixtures.json", "exists": pathlib.Path(summary_json_path.parent / "runtime/v124-commercial-negative-runtime-fixtures.json").is_file()},
    {"path": "runtime/v124-commercial-golden-path.json", "exists": pathlib.Path(summary_json_path.parent / "runtime/v124-commercial-golden-path.json").is_file()},
    {"path": "runtime/v124-release-certification.json", "exists": pathlib.Path(summary_json_path.parent / "runtime/v124-release-certification.json").is_file()},
...
root_runtime_metadata_matches = (
    ...
    and root_runtime_certification.get("releaseTag") == root_release_tag
    and root_runtime_certification.get("sourceCommit") == root_source_commit
    and root_runtime_certification.get("workflowRunId") == root_workflow_run_id
    and root_runtime_certification.get("artifactNames") == root_artifact_names
    and root_runtime_certification.get("primaryProofs") == root_primary_proofs
)
if current_status == "passed" and (not root_runtime_metadata_matches or not root_primary_proofs):
    current_status = "failed"
    current_stage = "root-runtime-metadata"
    current_message = f"root certification metadata does not match {root_runtime_certification_path}"
...
checklist = [
    ...
    {
        "id": "root-runtime-metadata-match",
        "label": "root certification exposes top-level metadata matching runtime release certification",
        "passed": root_runtime_metadata_matches and bool(root_primary_proofs),
    },
    {
...
certification_payload = {
    ...
    "runtimeReleaseCertificationPath": root_runtime_certification_path if root_runtime_certification else None,
    "rootRuntimeMetadataMatches": root_runtime_metadata_matches,
...
payload = {
    ...
    "observedState": {
        ...
        "milestoneFound": None,
        "milestoneState": None,
        "hasNoOpenIssues": None,
        "isMilestoneClosed": None,
...
def write_deferred_and_exit(reason):
    payload = {
        "version": "agentflow-live-github-milestone-closeout.v1",
        "status": "deferred",
        "reason": reason,
    ...
    while True:
        ...
        try:
            ...
            if require_published == "1":
                raise
            write_deferred_and_exit(str(exc))
...
has_no_open_issues = len(open_issues) == 0
is_milestone_closed = milestone_state == "closed"
if is_milestone_closed:
    closeout_state = "closed"
elif has_no_open_issues:
    closeout_state = "open-no-open-issues"
else:
    closeout_state = "open-with-open-issues"
...
payload.update({
    ...
    "observedState": {
        ...
        "hasNoOpenIssues": has_no_open_issues,
        "isMilestoneClosed": is_milestone_closed,
    ...
    "deprecatedFields": {
        "distinguishesNoOpenIssuesFromClosedMilestone": "use hasNoOpenIssues and isMilestoneClosed"
    },
})
pathlib.Path(out_raw).write_text(json.dumps(payload, ensure_ascii=False, indent=2) + "\n", encoding="utf-8")
if status == "failed":
...
tracked_docs = [
    ...
    "docs/delivery/releases/v1.1.3/README.md",
    "docs/delivery/releases/v1.1.2/README.md",
...
payload = {
    ...
    "currentReleaseBaselineEntry": "docs/delivery/releases/v1.1.2/README.md",
...
def version_at_or_after(value, minimum):
    ...
    actual_parts = normalize(value)
    minimum_parts = normalize(minimum)
    return actual_parts is not None and minimum_parts is not None and actual_parts >= minimum_parts

coverage = {
    "release-version-at-or-after-v108": version_at_or_after(release_version, expected_tag),
    "release-tag-at-or-after-v108": version_at_or_after(release_tag_name, expected_tag),
    "cargo-workspace-version-at-or-after-108": version_at_or_after(cargo["workspace"]["package"]["version"], expected_version),
    "desktop-package-version-at-or-after-108": version_at_or_after(desktop_package.get("version"), expected_version),
    "desktop-package-lock-version-at-or-after-108": version_at_or_after(desktop_package_lock.get("version"), expected_version)
    and version_at_or_after((desktop_package_lock.get("packages") or {}).get("", {}).get("version"), expected_version),
...
coverage = {
    "release-version-at-or-after-v109": release_version in {expected_tag, "v1.1.0", "v1.1.1", "v1.1.2", "v1.1.3", "v1.1.4", "v1.1.5", "v1.1.6", "v1.1.7", "v1.1.8", "v1.1.9", "v1.2.0", "v1.2.1", "v1.2.2", "v1.2.3", "v1.2.4", "v1.2.5", "v1.2.6", "v1.2.7", "v1.2.8", "v1.2.9"},
    "release-tag-at-or-after-v109": release_tag_name in {expected_tag, "v1.1.0", "v1.1.1", "v1.1.2", "v1.1.3", "v1.1.4", "v1.1.5", "v1.1.6", "v1.1.7", "v1.1.8", "v1.1.9", "v1.2.0", "v1.2.1", "v1.2.2", "v1.2.3", "v1.2.4", "v1.2.5", "v1.2.6", "v1.2.7", "v1.2.8", "v1.2.9"},
    "cargo-workspace-version-at-or-after-109": cargo["workspace"]["package"]["version"] in {expected_version, "1.1.0", "1.1.1", "1.1.2", "1.1.3", "1.1.4", "1.1.5", "1.1.6", "1.1.7", "1.1.8", "1.1.9", "1.2.0", "1.2.1", "1.2.2", "1.2.3", "1.2.4", "1.2.5", "1.2.6", "1.2.7", "1.2.8", "1.2.9"},
    "desktop-package-version-at-or-after-109": desktop_package.get("version") in {expected_version, "1.1.0", "1.1.1", "1.1.2", "1.1.3", "1.1.4", "1.1.5", "1.1.6", "1.1.7", "1.1.8", "1.1.9", "1.2.0", "1.2.1", "1.2.2", "1.2.3", "1.2.4", "1.2.5", "1.2.6", "1.2.7", "1.2.8", "1.2.9"},
    "desktop-package-lock-version-at-or-after-109": desktop_package_lock.get("version") in {expected_version, "1.1.0", "1.1.1", "1.1.2", "1.1.3", "1.1.4", "1.1.5", "1.1.6", "1.1.7", "1.1.8", "1.1.9", "1.2.0", "1.2.1", "1.2.2", "1.2.3", "1.2.4", "1.2.5", "1.2.6", "1.2.7", "1.2.8", "1.2.9"}
    and (desktop_package_lock.get("packages") or {}).get("", {}).get("version") in {expected_version, "1.1.0", "1.1.1", "1.1.2", "1.1.3", "1.1.4", "1.1.5", "1.1.6", "1.1.7", "1.1.8", "1.1.9", "1.2.0", "1.2.1", "1.2.2", "1.2.3", "1.2.4", "1.2.5", "1.2.6", "1.2.7", "1.2.8", "1.2.9"},
    "tauri-version-at-or-after-109": tauri_config.get("version") in {expected_version, "1.1.0", "1.1.1", "1.1.2", "1.1.3", "1.1.4", "1.1.5", "1.1.6", "1.1.7", "1.1.8", "1.1.9", "1.2.0", "1.2.1", "1.2.2", "1.2.3", "1.2.4", "1.2.5", "1.2.6", "1.2.7", "1.2.8", "1.2.9"},
...
release_version_checks = {
    "release-version-at-least-v111": version_at_least(release_version, expected_tag),
    "release-tag-at-least-v111": version_at_least(release_tag_name, expected_tag),
    "cargo-workspace-version-at-least-111": version_at_least(cargo["workspace"]["package"]["version"], expected_version),
    "desktop-package-version-at-least-111": version_at_least(desktop_package.get("version"), expected_version),
    "desktop-package-lock-version-at-least-111": version_at_least(desktop_package_lock.get("version"), expected_version)
    and version_at_least((desktop_package_lock.get("packages") or {}).get("", {}).get("version"), expected_version),
    "tauri-version-at-least-111": version_at_least(tauri_config.get("version"), expected_version),
}
task_traceability_checks = {
    "all-task-ids-present": all(task_id in release_tasks_text for task_id, _, _, _ in task_rows),
    "all-github-issue-refs-present": all(f"#{number}" in release_tasks_text for _, number, _, _ in task_rows),
...
run_v112_release_certification_gate() {
  record_stage "v112-release-certification" "started" "$V112_RELEASE_CERTIFICATION_PATH"

  cargo run -p agentflow-runtime-api --example v112_product_execution_proofs --manifest-path "$WORKSPACE/Cargo.toml" -- \
    "$WORKSPACE" \
    "$V112_REAL_PRODUCT_RUNTIME_PROOF_PATH" \
    "$V112_REAL_PRODUCT_PROJECTION_PROOF_PATH" \
    "$V112_REGISTRY_DISCOVERED_SECOND_PRODUCT_PATH" \
    "$V112_DESKTOP_PRODUCT_COMMAND_ROUTE_READ_MODEL_PATH" \
    "$V112_MULTI_PRODUCT_CONSOLE_STATES_PATH" >/dev/null

  python3 - \
    "$WORKSPACE" \
    "$V112_PRODUCT_BRIDGE_POLLUTION_SCAN_PATH" <<'PY'
import json
import pathlib
import sys
import time
...
scan_roots = [
    workspace / "crates/pack",
    workspace / "crates/runtime-api",
    workspace / "crates/projection",
]
forbidden_tokens = [
    "software-dev-task-workbench",
    "product_required_capability",
    "product_page_for_command",
    "trading venue",
    "market data adapter",
]
findings = []
...
negative_fixture = "hardcoded product route: software-dev-task-workbench"
negative_fixture_detected = any(token in negative_fixture for token in forbidden_tokens)
checks = {
    "scan-roots-exist": all(root.is_dir() for root in scan_roots),
    "no-product-bridge-pollution-found": not findings,
    "negative-fixture-detected": negative_fixture_detected,
    "generic-product-terms-allowed": "ProductCommandSurfaceView" in (workspace / "crates/runtime-api/src/pack.rs").read_text(encoding="utf-8"),
}
payload = {
    "version": "agentflow-v112-product-bridge-pollution-scan.v1",
    "status": "passed" if all(checks.values()) else "failed",
    "scanRoots": [root.relative_to(workspace).as_posix() for root in scan_roots],
    "forbiddenTokens": forbidden_tokens,
    "findings": findings,
    "negativeFixture": negative_fixture,
    "coverage": checks,
    "failedCoverage": [key for key, value in checks.items() if not value],
    "checkedAt": int(time.time()),
}
out.write_text(json.dumps(payload, ensure_ascii=False, indent=2) + "\n", encoding="utf-8")
if payload["status"] != "passed":
    raise SystemExit(f"v112 pollution scan failed: {payload['failedCoverage']}")
PY

  python3 - \
    "$WORKSPACE" \
    "$V112_DESKTOP_PRODUCT_COMMAND_ROUTE_READ_MODEL_PATH" \
    "$V112_DESKTOP_COMMAND_BUTTON_INSTALLATION_PATH" <<'PY'
import json
import pathlib
import sys
import time
...
workspace = pathlib.Path(sys.argv[1])
read_model_path = pathlib.Path(sys.argv[2])
out = pathlib.Path(sys.argv[3])
read_model = json.loads(read_model_path.read_text(encoding="utf-8"))
app_tsx = (workspace / "apps/desktop/src/App.tsx").read_text(encoding="utf-8")
tauri_commands = (workspace / "apps/desktop/src-tauri/src/commands/runtime_api.rs").read_text(encoding="utf-8")
tauri_main = (workspace / "apps/desktop/src-tauri/src/main.rs").read_text(encoding="utf-8")
checks = {
    "desktop-read-model-passed": read_model.get("status") == "passed",
    "tauri-load-command-registered": "load_product_command_surface" in tauri_commands and "load_product_command_surface" in tauri_main,
    "tauri-dry-run-command-registered": "dry_run_product_command" in tauri_commands and "dry_run_product_command" in tauri_main,
    "app-loads-product-command-surface": "useProductCommandSurface" in app_tsx,
    "app-renders-product-commands": "productCommandEntries" in app_tsx and "ProductCommandSurface -> validate_pack_command" in app_tsx,
    "browser-preview-has-product-command-surface": "buildBrowserPreviewProductCommandSurface" in app_tsx,
}
payload = {
    "version": "agentflow-v112-desktop-command-button-installation.v1",
    "status": "passed" if all(checks.values()) else "failed",
    "readModelPath": "runtime/v112-desktop-product-command-route-read-model.json",
    "sourceRefs": [
...
out.write_text(json.dumps(payload, ensure_ascii=False, indent=2) + "\n", encoding="utf-8")
if payload["status"] != "passed":
    raise SystemExit(f"v112 desktop button installation failed: {payload['failedCoverage']}")
PY
  ...
  python3 - \
    ...
    "$ROOT/CHANGELOG.md" \
    "$ARTIFACT_MANIFEST_PATH" \
    "$V111_RELEASE_CERTIFICATION_PATH" \
    "$V112_REAL_PRODUCT_RUNTIME_PROOF_PATH" \
    "$V112_REAL_PRODUCT_PROJECTION_PROOF_PATH" \
    "$V112_PRODUCT_BRIDGE_POLLUTION_SCAN_PATH" \
    "$V112_REGISTRY_DISCOVERED_SECOND_PRODUCT_PATH" \
    "$V112_DESKTOP_PRODUCT_COMMAND_ROUTE_READ_MODEL_PATH" \
    "$V112_DESKTOP_COMMAND_BUTTON_INSTALLATION_PATH" \
    "$V112_MULTI_PRODUCT_CONSOLE_STATES_PATH" \
    "$V112_RELEASE_CERTIFICATION_PATH" <<'PY'
import hashlib
import json
import pathlib
import sys
...
workspace = pathlib.Path(workspace_raw)
changelog_path = pathlib.Path(changelog_raw)
artifact_manifest_path = pathlib.Path(artifact_manifest_raw)
artifact_paths = [
    pathlib.Path(runtime_raw),
    pathlib.Path(projection_raw),
    pathlib.Path(pollution_raw),
    pathlib.Path(registry_raw),
    pathlib.Path(desktop_raw),
    pathlib.Path(button_raw),
    pathlib.Path(multi_product_raw),
]
certification_path = pathlib.Path(certification_raw)
v111_certification_path = pathlib.Path(v111_certification_raw)
...
delivery_readme_text = read_text("docs/delivery/README.md")
changelog_text = changelog_path.read_text(encoding="utf-8")
release_readme_text = read_text("docs/delivery/releases/v1.1.2/README.md")
release_tasks_text = read_text("docs/delivery/releases/v1.1.2/AGENTFLOW_V1_1_2_PRODUCT_EXECUTION_PROOF_COMMAND_SURFACE_TASKS_V1.md")
v111_certification = json.loads(v111_certification_path.read_text(encoding="utf-8"))
artifacts = {
    path.name: json.loads(path.read_text(encoding="utf-8"))
    for path in artifact_paths
}
task_rows = [
    ("V112-001", 766, "Real Product Runtime Proof Harness", pathlib.Path(runtime_raw)),
    ("V112-002", 767, "Real Projection Read Model Proof Harness", pathlib.Path(projection_raw)),
    ("V112-003", 768, "Recursive Product Bridge Pollution Scanner", pathlib.Path(pollution_raw)),
    ("V112-004", 769, "Registry-discovered Second Product Fixture", pathlib.Path(registry_raw)),
    ("V112-005", 770, "Desktop Product Command Route Read Model", pathlib.Path(desktop_raw)),
    ("V112-006", 771, "Desktop Command Button Installation", pathlib.Path(button_raw)),
    ("V112-007", 772, "Multi-product Console Invalid / Deferred States", pathlib.Path(multi_product_raw)),
    ("V112-008", 773, "v1.1.2 Release Certification", certification_path),
]
certified_hashes = [
    artifact_hash(v111_certification_path),
    *[artifact_hash(path) for path in artifact_paths],
]
artifact_manifest_sha256 = hashlib.sha256(artifact_manifest_path.read_bytes()).hexdigest() if artifact_manifest_path.is_file() else None
certification_digest = hashlib.sha256(json.dumps({
    "releaseVersion": release_version,
    "releaseTagName": release_tag_name,
    "certifiedArtifactHashes": certified_hashes,
...
checks = {
    "release-version-at-or-after-v112": release_version in {"v1.1.2", "v1.1.3", "v1.1.4", "v1.1.5", "v1.1.6", "v1.1.7", "v1.1.8", "v1.1.9", "v1.2.0", "v1.2.1", "v1.2.2", "v1.2.3", "v1.2.4", "v1.2.5", "v1.2.6", "v1.2.7", "v1.2.8", "v1.2.9"},
    "release-tag-at-or-after-v112": release_tag_name in {"v1.1.2", "v1.1.3", "v1.1.4", "v1.1.5", "v1.1.6", "v1.1.7", "v1.1.8", "v1.1.9", "v1.2.0", "v1.2.1", "v1.2.2", "v1.2.3", "v1.2.4", "v1.2.5", "v1.2.6", "v1.2.7", "v1.2.8", "v1.2.9"},
    "cargo-workspace-version-at-or-after-112": cargo["workspace"]["package"]["version"] in {"1.1.2", "1.1.3", "1.1.4", "1.1.5", "1.1.6", "1.1.7", "1.1.8", "1.1.9", "1.2.0", "1.2.1", "1.2.2", "1.2.3", "1.2.4", "1.2.5", "1.2.6", "1.2.7", "1.2.8", "1.2.9"},
    "desktop-package-version-at-or-after-112": desktop_package.get("version") in {"1.1.2", "1.1.3", "1.1.4", "1.1.5", "1.1.6", "1.1.7", "1.1.8", "1.1.9", "1.2.0", "1.2.1", "1.2.2", "1.2.3", "1.2.4", "1.2.5", "1.2.6", "1.2.7", "1.2.8", "1.2.9"},
    "desktop-package-lock-version-at-or-after-112": desktop_package_lock.get("version") in {"1.1.2", "1.1.3", "1.1.4", "1.1.5", "1.1.6", "1.1.7", "1.1.8", "1.1.9", "1.2.0", "1.2.1", "1.2.2", "1.2.3", "1.2.4", "1.2.5", "1.2.6", "1.2.7", "1.2.8", "1.2.9"} and (desktop_package_lock.get("packages") or {}).get("", {}).get("version") in {"1.1.2", "1.1.3", "1.1.4", "1.1.5", "1.1.6", "1.1.7", "1.1.8", "1.1.9", "1.2.0", "1.2.1", "1.2.2", "1.2.3", "1.2.4", "1.2.5", "1.2.6", "1.2.7", "1.2.8", "1.2.9"},
    "tauri-version-at-or-after-112": tauri_config.get("version") in {"1.1.2", "1.1.3", "1.1.4", "1.1.5", "1.1.6", "1.1.7", "1.1.8", "1.1.9", "1.2.0", "1.2.1", "1.2.2", "1.2.3", "1.2.4", "1.2.5", "1.2.6", "1.2.7", "1.2.8", "1.2.9"},
    ...
    "changelog-has-v112-entry": "## v1.1.2 - 2026-07-02" in changelog_text and "Product Execution Proof" in changelog_text,
    "all-task-ids-present": all(task_id in release_tasks_text for task_id, _, _, _ in task_rows),
    "all-github-issue-refs-present": all(f"#{number}" in release_tasks_text for _, number, _, _ in task_rows),
    "all-task-titles-present": all(title in release_tasks_text for _, _, title, _ in task_rows),
    "all-tasks-done": release_tasks_text.count("状态：done") >= len(task_rows),
    "release-event-evidence-recorded": bool(gate_event_name) and bool(source_commit_sha) and bool(release_tag_name),
    "release-run-id-bound-for-ci": gate_event_name == "local" or bool(gate_run_id),
    "release-run-url-bound-for-ci": gate_event_name == "local" or bool(gate_run_url),
    "certified-artifact-hashes-present": len(certified_hashes) == len(artifact_paths) + 1 and all(item["sha256"] and item["bytes"] > 0 for item in certified_hashes),
    "artifact-manifest-digest-present": artifact_manifest_sha256 is not None,
}
...
payload = {
    "version": "agentflow-v112-release-certification.v1",
    "status": "passed" if not failed else "failed",
    "releaseVersion": "v1.1.2",
    "workspaceVersion": "1.1.2",
    "certifiedArtifacts": {name: payload.get("status") for name, payload in artifacts.items()},
    "certifiedArtifactHashes": certified_hashes,
    "eventEvidence": event_evidence,
    "coverage": checks,
    "failedCoverage": failed,
    "releaseBaseline": "docs/delivery/releases/v1.1.2/README.md",
    "releaseTasks": "docs/delivery/releases/v1.1.2/AGENTFLOW_V1_1_2_PRODUCT_EXECUTION_PROOF_COMMAND_SURFACE_TASKS_V1.md",
    "remainingRisks": [],
    "checkedAt": int(time.time()),
}
certification_path.write_text(json.dumps(payload, ensure_ascii=False, indent=2) + "\n", encoding="utf-8")
if failed:
    raise SystemExit(f"v1.1.2 release certification failed: {failed}")
PY

  record_stage "v112-real-product-runtime-proof" "passed" "$(basename "$V112_REAL_PRODUCT_RUNTIME_PROOF_PATH")"
  record_stage "v112-real-product-projection-proof" "passed" "$(basename "$V112_REAL_PRODUCT_PROJECTION_PROOF_PATH")"
  record_stage "v112-product-bridge-pollution-scan" "passed" "$(basename "$V112_PRODUCT_BRIDGE_POLLUTION_SCAN_PATH")"
  record_stage "v112-registry-discovered-second-product" "passed" "$(basename "$V112_REGISTRY_DISCOVERED_SECOND_PRODUCT_PATH")"
  record_stage "v112-desktop-product-command-route-read-model" "passed" "$(basename "$V112_DESKTOP_PRODUCT_COMMAND_ROUTE_READ_MODEL_PATH")"
  record_stage "v112-desktop-command-button-installation" "passed" "$(basename "$V112_DESKTOP_COMMAND_BUTTON_INSTALLATION_PATH")"
  record_stage "v112-multi-product-console-states" "passed" "$(basename "$V112_MULTI_PRODUCT_CONSOLE_STATES_PATH")"
  record_stage "v112-release-certification" "passed" "$(basename "$V112_RELEASE_CERTIFICATION_PATH")"
}

run_v113_release_certification_gate() {
  record_stage "v113-release-certification" "started" "$V113_RELEASE_CERTIFICATION_PATH"

  cargo run -p agentflow-runtime-api --example v113_product_command_submit_proofs --manifest-path "$WORKSPACE/Cargo.toml" -- \
    "$WORKSPACE" \
    "$V113_PRODUCT_COMMAND_STATE_CONTRACT_PATH" \
    "$V113_PRODUCT_COMMAND_SUBMIT_CONTRACT_PATH" \
    "$V113_RUNTIME_PRODUCT_COMMAND_SUBMIT_API_PATH" \
    "$V113_PRODUCT_COMMAND_EVIDENCE_HANDOFF_PATH" \
    "$V113_MULTI_PRODUCT_STATE_UI_PROOF_PATH" >/dev/null

  python3 - \
    "$WORKSPACE" \
    "$V113_SEMANTIC_PRODUCT_BRIDGE_POLLUTION_SCAN_PATH" <<'PY'
import json
import pathlib
import sys
import time
...
for root in scan_roots:
    for path in root.rglob("*"):
        ...
        text = path.read_text(encoding="utf-8", errors="ignore")
        for token in forbidden_tokens:
            if token in text and relative not in allowlist:
                findings.append({"path": relative, "token": token})
negative_fixture = "hardcoded Product id: software-dev-task-workbench fallback product route"
negative_fixture_detected = all(token in negative_fixture for token in ["hardcoded Product id", "fallback product route"])
checks = {
    "scan-roots-exist": all(root.is_dir() for root in scan_roots),
    "no-product-bridge-pollution-found": not findings,
    "negative-fixture-detected": negative_fixture_detected,
    "state-contract-is-generic": "ProductCommandState" in (workspace / "crates/runtime-api/src/pack.rs").read_text(encoding="utf-8"),
    "submit-contract-is-generic": "submit_product_command" in (workspace / "crates/runtime-api/src/pack.rs").read_text(encoding="utf-8"),
}
payload = {
    "version": "agentflow-v113-semantic-product-bridge-pollution-scan.v1",
    "status": "passed" if all(checks.values()) else "failed",
    "scanRoots": [root.relative_to(workspace).as_posix() for root in scan_roots],
    "forbiddenTokens": forbidden_tokens,
...
out.write_text(json.dumps(payload, ensure_ascii=False, indent=2) + "\n", encoding="utf-8")
if payload["status"] != "passed":
    raise SystemExit(f"v113 pollution scan failed: {payload['failedCoverage']}")
PY

  python3 - \
    "$WORKSPACE" \
    "$V113_MULTI_PRODUCT_STATE_UI_PROOF_PATH" \
    "$V113_DESKTOP_CONFIRM_SUBMIT_COMMAND_FLOW_PATH" <<'PY'
import json
import pathlib
import sys
import time
...
workspace = pathlib.Path(sys.argv[1])
multi_state_path = pathlib.Path(sys.argv[2])
out = pathlib.Path(sys.argv[3])
multi_state = json.loads(multi_state_path.read_text(encoding="utf-8"))
app_tsx = (workspace / "apps/desktop/src/App.tsx").read_text(encoding="utf-8")
tauri_commands = (workspace / "apps/desktop/src-tauri/src/commands/runtime_api.rs").read_text(encoding="utf-8")
tauri_main = (workspace / "apps/desktop/src-tauri/src/main.rs").read_text(encoding="utf-8")
checks = {
    "multi-state-proof-passed": multi_state.get("status") == "passed",
    "tauri-submit-command-registered": "submit_product_command" in tauri_commands and "submit_product_command" in tauri_main,
    "desktop-has-confirm-state": "pendingProductCommandSubmitId" in app_tsx and "确认提交" in app_tsx,
    "desktop-calls-submit-command": "\"submit_product_command\"" in app_tsx,
    "desktop-renders-runtime-state": "command.state" in app_tsx and "ProductCommandState" in app_tsx,
    "browser-preview-has-state-legend": "stateLegend" in app_tsx and "deferred" in app_tsx and "unavailable" in app_tsx,
}
payload = {
    "version": "agentflow-v113-desktop-confirm-submit-command-flow.v1",
    "status": "passed" if all(checks.values()) else "failed",
    "multiProductStatePath": "runtime/v113-multi-product-state-ui-proof.json",
    "sourceRefs": [
        "apps/desktop/src/App.tsx",
        "apps/desktop/src-tauri/src/commands/runtime_api.rs",
        "apps/desktop/src-tauri/src/main.rs",
...
out.write_text(json.dumps(payload, ensure_ascii=False, indent=2) + "\n", encoding="utf-8")
if payload["status"] != "passed":
    raise SystemExit(f"v113 desktop confirm-submit proof failed: {payload['failedCoverage']}")
PY
  ...
  python3 - \
    ...
    "$ROOT/CHANGELOG.md" \
    "$ARTIFACT_MANIFEST_PATH" \
    "$V112_RELEASE_CERTIFICATION_PATH" \
    "$V113_PRODUCT_COMMAND_STATE_CONTRACT_PATH" \
    "$V113_PRODUCT_COMMAND_SUBMIT_CONTRACT_PATH" \
    "$V113_RUNTIME_PRODUCT_COMMAND_SUBMIT_API_PATH" \
    "$V113_DESKTOP_CONFIRM_SUBMIT_COMMAND_FLOW_PATH" \
    "$V113_PRODUCT_COMMAND_EVIDENCE_HANDOFF_PATH" \
    "$V113_MULTI_PRODUCT_STATE_UI_PROOF_PATH" \
    "$V113_SEMANTIC_PRODUCT_BRIDGE_POLLUTION_SCAN_PATH" \
    "$V113_RELEASE_CERTIFICATION_PATH" <<'PY'
import hashlib
import json
import pathlib
import sys
...
artifact_manifest_path = pathlib.Path(artifact_manifest_raw)
certification_path = pathlib.Path(certification_raw)
v112_certification_path = pathlib.Path(v112_certification_raw)
artifact_paths = [
    pathlib.Path(state_raw),
    pathlib.Path(submit_raw),
    pathlib.Path(runtime_submit_raw),
    pathlib.Path(desktop_raw),
    pathlib.Path(evidence_raw),
    pathlib.Path(multi_state_raw),
    pathlib.Path(pollution_raw),
]
...
delivery_readme_text = read_text("docs/delivery/README.md")
changelog_text = changelog_path.read_text(encoding="utf-8")
release_readme_text = read_text("docs/delivery/releases/v1.1.3/README.md")
release_tasks_text = read_text("docs/delivery/releases/v1.1.3/AGENTFLOW_V1_1_3_PRODUCT_COMMAND_SUBMISSION_TASKS_V1.md")
v112_certification = json.loads(v112_certification_path.read_text(encoding="utf-8"))
artifacts = {path.name: json.loads(path.read_text(encoding="utf-8")) for path in artifact_paths}
task_rows = [
    ("V113-001", 775, "Product Command State Contract", pathlib.Path(state_raw)),
    ("V113-002", 776, "Product Command Submission Contract", pathlib.Path(submit_raw)),
    ("V113-003", 777, "Runtime Product Command Submit API", pathlib.Path(runtime_submit_raw)),
    ("V113-004", 778, "Desktop Confirm-then-Submit Command Flow", pathlib.Path(desktop_raw)),
    ("V113-005", 779, "Product Command Evidence Handoff", pathlib.Path(evidence_raw)),
    ("V113-006", 780, "Multi-product State UI Proof", pathlib.Path(multi_state_raw)),
    ("V113-007", 781, "Semantic Product Bridge Pollution Scanner", pathlib.Path(pollution_raw)),
    ("V113-008", 782, "v1.1.3 Release Certification", certification_path),
]
certified_hashes = [artifact_hash(v112_certification_path), *[artifact_hash(path) for path in artifact_paths]]
artifact_manifest_sha256 = hashlib.sha256(artifact_manifest_path.read_bytes()).hexdigest() if artifact_manifest_path.is_file() else None
certification_digest = hashlib.sha256(json.dumps({
    "releaseVersion": release_version,
    "releaseTagName": release_tag_name,
...
checks = {
    "release-version-at-or-after-v113": release_version in {"v1.1.3", "v1.1.4", "v1.1.5", "v1.1.6", "v1.1.7", "v1.1.8", "v1.1.9", "v1.2.0", "v1.2.1", "v1.2.2", "v1.2.3", "v1.2.4", "v1.2.5", "v1.2.6", "v1.2.7", "v1.2.8", "v1.2.9"},
    "release-tag-at-or-after-v113": release_tag_name in {"v1.1.3", "v1.1.4", "v1.1.5", "v1.1.6", "v1.1.7", "v1.1.8", "v1.1.9", "v1.2.0", "v1.2.1", "v1.2.2", "v1.2.3", "v1.2.4", "v1.2.5", "v1.2.6", "v1.2.7", "v1.2.8", "v1.2.9"},
    "cargo-workspace-version-at-or-after-113": cargo["workspace"]["package"]["version"] in {"1.1.3", "1.1.4", "1.1.5", "1.1.6", "1.1.7", "1.1.8", "1.1.9", "1.2.0", "1.2.1", "1.2.2", "1.2.3", "1.2.4", "1.2.5", "1.2.6", "1.2.7", "1.2.8", "1.2.9"},
    "desktop-package-version-at-or-after-113": desktop_package.get("version") in {"1.1.3", "1.1.4", "1.1.5", "1.1.6", "1.1.7", "1.1.8", "1.1.9", "1.2.0", "1.2.1", "1.2.2", "1.2.3", "1.2.4", "1.2.5", "1.2.6", "1.2.7", "1.2.8", "1.2.9"},
    "desktop-package-lock-version-at-or-after-113": desktop_package_lock.get("version") in {"1.1.3", "1.1.4", "1.1.5", "1.1.6", "1.1.7", "1.1.8", "1.1.9", "1.2.0", "1.2.1", "1.2.2", "1.2.3", "1.2.4", "1.2.5", "1.2.6", "1.2.7", "1.2.8", "1.2.9"} and (desktop_package_lock.get("packages") or {}).get("", {}).get("version") in {"1.1.3", "1.1.4", "1.1.5", "1.1.6", "1.1.7", "1.1.8", "1.1.9", "1.2.0", "1.2.1", "1.2.2", "1.2.3", "1.2.4", "1.2.5", "1.2.6", "1.2.7", "1.2.8", "1.2.9"},
    "tauri-version-at-or-after-113": tauri_config.get("version") in {"1.1.3", "1.1.4", "1.1.5", "1.1.6", "1.1.7", "1.1.8", "1.1.9", "1.2.0", "1.2.1", "1.2.2", "1.2.3", "1.2.4", "1.2.5", "1.2.6", "1.2.7", "1.2.8", "1.2.9"},
    ...
    "changelog-has-v113-entry": "## v1.1.3 - 2026-07-02" in changelog_text and "Product Command Submission" in changelog_text,
    "all-task-ids-present": all(task_id in release_tasks_text for task_id, _, _, _ in task_rows),
    "all-github-issue-refs-present": all(f"#{number}" in release_tasks_text for _, number, _, _ in task_rows),
    "all-task-titles-present": all(title in release_tasks_text for _, _, title, _ in task_rows),
    "all-tasks-done": release_tasks_text.count("状态：done") >= len(task_rows),
...
payload = {
    "version": "agentflow-v113-release-certification.v1",
    "status": "passed" if not failed else "failed",
    "releaseVersion": "v1.1.3",
    "workspaceVersion": "1.1.3",
    "certifiedArtifacts": {name: payload.get("status") for name, payload in artifacts.items()},
    "certifiedArtifactHashes": certified_hashes,
    "eventEvidence": event_evidence,
    "coverage": checks,
    "failedCoverage": failed,
    "releaseBaseline": "docs/delivery/releases/v1.1.3/README.md",
    "releaseTasks": "docs/delivery/releases/v1.1.3/AGENTFLOW_V1_1_3_PRODUCT_COMMAND_SUBMISSION_TASKS_V1.md",
    "remainingRisks": [],
    "checkedAt": int(time.time()),
}
certification_path.write_text(json.dumps(payload, ensure_ascii=False, indent=2) + "\n", encoding="utf-8")
if failed:
    raise SystemExit(f"v1.1.3 release certification failed: {failed}")
PY

  record_stage "v113-product-command-state-contract" "passed" "$(basename "$V113_PRODUCT_COMMAND_STATE_CONTRACT_PATH")"
  record_stage "v113-product-command-submit-contract" "passed" "$(basename "$V113_PRODUCT_COMMAND_SUBMIT_CONTRACT_PATH")"
  record_stage "v113-runtime-product-command-submit-api" "passed" "$(basename "$V113_RUNTIME_PRODUCT_COMMAND_SUBMIT_API_PATH")"
  record_stage "v113-desktop-confirm-submit-command-flow" "passed" "$(basename "$V113_DESKTOP_CONFIRM_SUBMIT_COMMAND_FLOW_PATH")"
  record_stage "v113-product-command-evidence-handoff" "passed" "$(basename "$V113_PRODUCT_COMMAND_EVIDENCE_HANDOFF_PATH")"
  record_stage "v113-multi-product-state-ui-proof" "passed" "$(basename "$V113_MULTI_PRODUCT_STATE_UI_PROOF_PATH")"
  record_stage "v113-semantic-product-bridge-pollution-scan" "passed" "$(basename "$V113_SEMANTIC_PRODUCT_BRIDGE_POLLUTION_SCAN_PATH")"
  record_stage "v113-release-certification" "passed" "$(basename "$V113_RELEASE_CERTIFICATION_PATH")"
}

run_v114_release_certification_gate() {
  record_stage "v114-release-certification" "started" "$V114_RELEASE_CERTIFICATION_PATH"

  cargo run -p agentflow-runtime-api --example v114_product_workspace_proofs --manifest-path "$WORKSPACE/Cargo.toml" -- \
    "$WORKSPACE" \
    "$V114_PRODUCT_SUBMIT_RECEIPT_BINDING_PATH" \
    "$V114_DESKTOP_CONFIRM_SUBMIT_INTERACTION_PATH" \
    "$V114_PRODUCT_BRIDGE_SEMANTIC_POLLUTION_SCAN_PATH" \
    "$V114_PROJECT_WORKSPACE_CREATION_CONTRACT_PATH" \
    "$V114_PRODUCT_SELECTED_WORKSPACE_BOOTSTRAP_PATH" \
    "$V114_STANDARD_DOCS_AGENTFLOW_FACT_SOURCE_INIT_PATH" \
    "$V114_ACTIVE_PRODUCT_WORKSPACE_PROJECTION_PATH" \
    "$V114_WORKSPACE_INIT_FAILURE_RECOVERY_PATH" \
    "$V114_SOFTWARE_DEV_WORKSPACE_GOLDEN_PATH_PATH" \
    "$V114_RELEASE_CERTIFICATION_PATH" >/dev/null
  ...
  python3 - \
    ...
    "$ROOT/CHANGELOG.md" \
    "$ARTIFACT_MANIFEST_PATH" \
    "$V113_RELEASE_CERTIFICATION_PATH" \
    "$V114_PRODUCT_SUBMIT_RECEIPT_BINDING_PATH" \
    "$V114_DESKTOP_CONFIRM_SUBMIT_INTERACTION_PATH" \
    "$V114_PRODUCT_BRIDGE_SEMANTIC_POLLUTION_SCAN_PATH" \
    "$V114_PROJECT_WORKSPACE_CREATION_CONTRACT_PATH" \
    ...
    "$V114_WORKSPACE_INIT_FAILURE_RECOVERY_PATH" \
    "$V114_SOFTWARE_DEV_WORKSPACE_GOLDEN_PATH_PATH" \
    "$V114_RELEASE_CERTIFICATION_PATH" <<'PY'
import hashlib
import json
import pathlib
import sys
...
(
    ...
    changelog_raw,
    artifact_manifest_raw,
    v113_certification_raw,
    receipt_raw,
    desktop_raw,
    pollution_raw,
    workspace_contract_raw,
    bootstrap_raw,
    standard_init_raw,
    projection_raw,
    failure_raw,
...
artifact_manifest_path = pathlib.Path(artifact_manifest_raw)
certification_path = pathlib.Path(certification_raw)
v113_certification_path = pathlib.Path(v113_certification_raw)
artifact_paths = [
    pathlib.Path(receipt_raw),
    pathlib.Path(desktop_raw),
    pathlib.Path(pollution_raw),
    pathlib.Path(workspace_contract_raw),
    pathlib.Path(bootstrap_raw),
    pathlib.Path(standard_init_raw),
    pathlib.Path(projection_raw),
    pathlib.Path(failure_raw),
    pathlib.Path(golden_raw),
]
...
docs_readme_text = read_text("docs/README.md")
delivery_readme_text = read_text("docs/delivery/README.md")
release_readme_text = read_text("docs/delivery/releases/v1.1.4/README.md")
release_tasks_text = read_text("docs/delivery/releases/v1.1.4/AGENTFLOW_V1_1_4_PROJECT_CREATION_PRODUCT_WORKSPACE_TASKS_V1.md")
changelog_text = changelog_path.read_text(encoding="utf-8")
v113_certification = json.loads(v113_certification_path.read_text(encoding="utf-8"))
artifacts = {path.name: json.loads(path.read_text(encoding="utf-8")) for path in artifact_paths}
task_rows = [
    ("V114-001", 785, "Product Submit Receipt Binding", pathlib.Path(receipt_raw)),
    ("V114-002", 786, "Desktop Confirm-submit Interaction Proof", pathlib.Path(desktop_raw)),
    ("V114-003", 787, "Product Bridge Semantic Pollution Scanner", pathlib.Path(pollution_raw)),
    ("V114-004", 788, "Project Workspace Creation Contract", pathlib.Path(workspace_contract_raw)),
    ("V114-005", 789, "Product-selected Workspace Bootstrap", pathlib.Path(bootstrap_raw)),
    ("V114-006", 790, "Standard Docs and AgentFlow Fact Source Initialization", pathlib.Path(standard_init_raw)),
    ("V114-007", 791, "Active Product Workspace State and Projection", pathlib.Path(projection_raw)),
    ("V114-008", 792, "Workspace Init Failure / Duplicate / Recovery", pathlib.Path(failure_raw)),
    ("V114-009", 793, "Software Dev Default Workspace Golden Path", pathlib.Path(golden_raw)),
    ("V114-010", 794, "v1.1.4 Release Certification", certification_path),
]
certified_hashes = [artifact_hash(v113_certification_path), *[artifact_hash(path) for path in artifact_paths]]
artifact_manifest_sha256 = hashlib.sha256(artifact_manifest_path.read_bytes()).hexdigest() if artifact_manifest_path.is_file() else None
certification_digest = hashlib.sha256(json.dumps({
    "releaseVersion": release_version,
    "releaseTagName": release_tag_name,
...
checks = {
    "release-version-is-v114": release_version in {"v1.1.4", "v1.1.5", "v1.1.6", "v1.1.7", "v1.1.8", "v1.1.9", "v1.2.0", "v1.2.1", "v1.2.2", "v1.2.3", "v1.2.4", "v1.2.5", "v1.2.6", "v1.2.7", "v1.2.8", "v1.2.9"},
    "release-tag-is-v114": release_tag_name in {"v1.1.4", "v1.1.5", "v1.1.6", "v1.1.7", "v1.1.8", "v1.1.9", "v1.2.0", "v1.2.1", "v1.2.2", "v1.2.3", "v1.2.4", "v1.2.5", "v1.2.6", "v1.2.7", "v1.2.8", "v1.2.9"},
    "cargo-workspace-version-is-114": cargo["workspace"]["package"]["version"] in {"1.1.4", "1.1.5", "1.1.6", "1.1.7", "1.1.8", "1.1.9", "1.2.0", "1.2.1", "1.2.2", "1.2.3", "1.2.4", "1.2.5", "1.2.6", "1.2.7", "1.2.8", "1.2.9"},
    "desktop-package-version-is-114": desktop_package.get("version") in {"1.1.4", "1.1.5", "1.1.6", "1.1.7", "1.1.8", "1.1.9", "1.2.0", "1.2.1", "1.2.2", "1.2.3", "1.2.4", "1.2.5", "1.2.6", "1.2.7", "1.2.8", "1.2.9"},
    "desktop-package-lock-version-is-114": desktop_package_lock.get("version") in {"1.1.4", "1.1.5", "1.1.6", "1.1.7", "1.1.8", "1.1.9", "1.2.0", "1.2.1", "1.2.2", "1.2.3", "1.2.4", "1.2.5", "1.2.6", "1.2.7", "1.2.8", "1.2.9"} and (desktop_package_lock.get("packages") or {}).get("", {}).get("version") in {"1.1.4", "1.1.5", "1.1.6", "1.1.7", "1.1.8", "1.1.9", "1.2.0", "1.2.1", "1.2.2", "1.2.3", "1.2.4", "1.2.5", "1.2.6", "1.2.7", "1.2.8", "1.2.9"},
    "tauri-version-is-114": tauri_config.get("version") in {"1.1.4", "1.1.5", "1.1.6", "1.1.7", "1.1.8", "1.1.9", "1.2.0", "1.2.1", "1.2.2", "1.2.3", "1.2.4", "1.2.5", "1.2.6", "1.2.7", "1.2.8", "1.2.9"},
...
payload = {
    ...
    "workspaceVersion": "1.1.4",
    "certifiedArtifacts": {name: payload.get("status") for name, payload in artifacts.items()},
    "certifiedArtifactHashes": certified_hashes,
    "eventEvidence": event_evidence,
    "coverage": checks,
    "failedCoverage": failed,
    "releaseBaseline": "docs/delivery/releases/v1.1.4/README.md",
    "releaseTasks": "docs/delivery/releases/v1.1.4/AGENTFLOW_V1_1_4_PROJECT_CREATION_PRODUCT_WORKSPACE_TASKS_V1.md",
    "remainingRisks": [],
    "checkedAt": int(time.time()),
}
certification_path.write_text(json.dumps(payload, ensure_ascii=False, indent=2) + "\n", encoding="utf-8")
if failed:
    raise SystemExit(f"v1.1.4 release certification failed: {failed}")
PY

  record_stage "v114-product-submit-receipt-binding" "passed" "$(basename "$V114_PRODUCT_SUBMIT_RECEIPT_BINDING_PATH")"
  record_stage "v114-desktop-confirm-submit-interaction" "passed" "$(basename "$V114_DESKTOP_CONFIRM_SUBMIT_INTERACTION_PATH")"
  record_stage "v114-product-bridge-semantic-pollution-scan" "passed" "$(basename "$V114_PRODUCT_BRIDGE_SEMANTIC_POLLUTION_SCAN_PATH")"
  record_stage "v114-project-workspace-creation-contract" "passed" "$(basename "$V114_PROJECT_WORKSPACE_CREATION_CONTRACT_PATH")"
  record_stage "v114-product-selected-workspace-bootstrap" "passed" "$(basename "$V114_PRODUCT_SELECTED_WORKSPACE_BOOTSTRAP_PATH")"
  record_stage "v114-standard-docs-agentflow-fact-source-init" "passed" "$(basename "$V114_STANDARD_DOCS_AGENTFLOW_FACT_SOURCE_INIT_PATH")"
  record_stage "v114-active-product-workspace-projection" "passed" "$(basename "$V114_ACTIVE_PRODUCT_WORKSPACE_PROJECTION_PATH")"
  record_stage "v114-workspace-init-failure-recovery" "passed" "$(basename "$V114_WORKSPACE_INIT_FAILURE_RECOVERY_PATH")"
  record_stage "v114-software-dev-workspace-golden-path" "passed" "$(basename "$V114_SOFTWARE_DEV_WORKSPACE_GOLDEN_PATH_PATH")"
  record_stage "v114-release-certification" "passed" "$(basename "$V114_RELEASE_CERTIFICATION_PATH")"
}

run_v115_release_certification_gate() {
  record_stage "v115-release-certification" "started" "$V115_RELEASE_CERTIFICATION_PATH"
  ...
  cargo run -p agentflow-runtime-api --example v115_spec_intake_productization_proofs --manifest-path "$WORKSPACE/Cargo.toml" -- \
    "$WORKSPACE" \
    "$V115_NEXT_RELEASE_PLANNING_ALIGNMENT_PATH" \
    "$V115_PRODUCT_WORKSPACE_DESKTOP_ENTRY_BRIDGE_PATH" \
    "$V115_PORTABLE_WORKSPACE_RECEIPT_PROJECTION_PATHS_PATH" \
    "$V115_INTENT_INTAKE_CONTRACT_PATH" \
    "$V115_CORE_ROUTE_POLICY_PATH" \
    "$V115_SPEC_BUNDLE_GOAL_ROADMAP_TASK_DERIVATION_PATH" \
    "$V115_CONFIRMATION_GATE_AUTHORITY_BOUNDARY_PATH" \
    "$V115_SPEC_MATERIALIZER_DOCS_AGENTFLOW_AUTHORITY_PATH" \
    "$V115_SOFTWARE_DEV_SPEC_TO_TASKS_GOLDEN_PATH_PATH" \
    "$V115_RELEASE_CERTIFICATION_PATH" >/dev/null
  ...
  python3 - "$WORKSPACE" "$RELEASE_VERSION" "$RELEASE_TAG_NAME" \
    ...
    "$V115_SPEC_MATERIALIZER_DOCS_AGENTFLOW_AUTHORITY_PATH" \
    "$V115_SOFTWARE_DEV_SPEC_TO_TASKS_GOLDEN_PATH_PATH" \
    "$V115_RELEASE_CERTIFICATION_PATH" <<'PY'
import json
import pathlib
import sys
import tomllib
...
artifact_paths = [pathlib.Path(value) for value in sys.argv[4:]]
...
release_readme = (root / "docs/delivery/releases/v1.1.5/README.md").read_text(encoding="utf-8")
release_tasks = (root / "docs/delivery/releases/v1.1.5/AGENTFLOW_V1_1_5_SPEC_INTAKE_PRODUCTIZATION_TASKS_V1.md").read_text(encoding="utf-8")

checks = {
    "all-v115-artifacts-passed": all(payload.get("status") == "passed" for payload in artifacts),
    "release-version-v115": release_version in {"v1.1.5", "v1.1.6", "v1.1.7", "v1.1.8", "v1.1.9", "v1.2.0", "v1.2.1", "v1.2.2", "v1.2.3", "v1.2.4", "v1.2.5", "v1.2.6", "v1.2.7", "v1.2.8", "v1.2.9"} and release_tag in {"v1.1.5", "v1.1.6", "v1.1.7", "v1.1.8", "v1.1.9", "v1.2.0", "v1.2.1", "v1.2.2", "v1.2.3", "v1.2.4", "v1.2.5", "v1.2.6", "v1.2.7", "v1.2.8", "v1.2.9"},
    "workspace-version-v115": cargo_version in {"1.1.5", "1.1.6", "1.1.7", "1.1.8", "1.1.9", "1.2.0", "1.2.1", "1.2.2", "1.2.3", "1.2.4", "1.2.5", "1.2.6", "1.2.7", "1.2.8", "1.2.9"},
    "desktop-package-version-v115": package_json.get("version") in {"1.1.5", "1.1.6", "1.1.7", "1.1.8", "1.1.9", "1.2.0", "1.2.1", "1.2.2", "1.2.3", "1.2.4", "1.2.5", "1.2.6", "1.2.7", "1.2.8", "1.2.9"},
    "desktop-lock-version-v115": package_lock.get("version") in {"1.1.5", "1.1.6", "1.1.7", "1.1.8", "1.1.9", "1.2.0", "1.2.1", "1.2.2", "1.2.3", "1.2.4", "1.2.5", "1.2.6", "1.2.7", "1.2.8", "1.2.9"} and package_lock.get("packages", {}).get("", {}).get("version") in {"1.1.5", "1.1.6", "1.1.7", "1.1.8", "1.1.9", "1.2.0", "1.2.1", "1.2.2", "1.2.3", "1.2.4", "1.2.5", "1.2.6", "1.2.7", "1.2.8", "1.2.9"},
    "tauri-version-v115": tauri.get("version") in {"1.1.5", "1.1.6", "1.1.7", "1.1.8", "1.1.9", "1.2.0", "1.2.1", "1.2.2", "1.2.3", "1.2.4", "1.2.5", "1.2.6", "1.2.7", "1.2.8", "1.2.9"},
...
if certification["status"] != "passed":
    raise SystemExit(f"v115 release certification failed: {failed}")
PY

  record_stage "v115-next-release-planning-alignment" "passed" "$(basename "$V115_NEXT_RELEASE_PLANNING_ALIGNMENT_PATH")"
  record_stage "v115-product-workspace-desktop-entry-bridge" "passed" "$(basename "$V115_PRODUCT_WORKSPACE_DESKTOP_ENTRY_BRIDGE_PATH")"
  record_stage "v115-portable-workspace-receipt-projection-paths" "passed" "$(basename "$V115_PORTABLE_WORKSPACE_RECEIPT_PROJECTION_PATHS_PATH")"
  record_stage "v115-intent-intake-contract" "passed" "$(basename "$V115_INTENT_INTAKE_CONTRACT_PATH")"
  record_stage "v115-core-route-policy" "passed" "$(basename "$V115_CORE_ROUTE_POLICY_PATH")"
  record_stage "v115-spec-bundle-goal-roadmap-task-derivation" "passed" "$(basename "$V115_SPEC_BUNDLE_GOAL_ROADMAP_TASK_DERIVATION_PATH")"
  record_stage "v115-confirmation-gate-authority-boundary" "passed" "$(basename "$V115_CONFIRMATION_GATE_AUTHORITY_BOUNDARY_PATH")"
  record_stage "v115-spec-materializer-docs-agentflow-authority" "passed" "$(basename "$V115_SPEC_MATERIALIZER_DOCS_AGENTFLOW_AUTHORITY_PATH")"
  record_stage "v115-software-dev-spec-to-tasks-golden-path" "passed" "$(basename "$V115_SOFTWARE_DEV_SPEC_TO_TASKS_GOLDEN_PATH_PATH")"
  record_stage "v115-release-certification" "passed" "$(basename "$V115_RELEASE_CERTIFICATION_PATH")"
}

run_v116_release_certification_gate() {
  record_stage "v116-release-certification" "started" "$V116_RELEASE_CERTIFICATION_PATH"

  git -C "$WORKSPACE" checkout -B "$BOOTSTRAP_BRANCH" "$SOURCE_COMMIT_SHA" >/dev/null
  git -C "$WORKSPACE" reset --hard "$SOURCE_COMMIT_SHA" >/dev/null
  git -C "$WORKSPACE" clean -fdx >/dev/null

  cargo run -p agentflow-runtime-api --example v116_executor_real_execution_proofs --manifest-path "$WORKSPACE/Cargo.toml" -- \
    "$WORKSPACE" \
    "$V116_NEXT_RELEASE_AUTHORITY_ALIGNMENT_PATH" \
    "$V116_CORE_ROUTE_NEXT_ACTION_SEMANTICS_PATH" \
    "$V116_PRODUCT_SPEC_INTAKE_DESKTOP_INVOCATION_BRIDGE_PATH" \
    "$V116_EXECUTOR_ADAPTER_HANDOFF_PACKAGE_PATH" \
    "$V116_ALLOWED_SURFACE_DIFF_BOUNDARY_CHECK_PATH" \
    "$V116_EXECUTOR_EVIDENCE_CAPTURE_PATH" \
    "$V116_EXECUTOR_RESULT_ISSUE_RUN_WRITEBACK_PATH" \
    "$V116_FAILURE_TIMEOUT_CANCEL_RETRY_SEMANTICS_PATH" \
    "$V116_SOFTWARE_DEV_REAL_EXECUTOR_GOLDEN_PATH_PATH" \
    "$V116_RELEASE_CERTIFICATION_PATH" >/dev/null
  ...
  python3 - "$WORKSPACE" "$RELEASE_VERSION" "$RELEASE_TAG_NAME" \
    ...
    "$V116_FAILURE_TIMEOUT_CANCEL_RETRY_SEMANTICS_PATH" \
    "$V116_SOFTWARE_DEV_REAL_EXECUTOR_GOLDEN_PATH_PATH" \
    "$V116_RELEASE_CERTIFICATION_PATH" <<'PY'
import json
import pathlib
import sys
import tomllib
...
release_readme = (root / "docs/delivery/releases/v1.1.6/README.md").read_text(encoding="utf-8")
release_tasks = (root / "docs/delivery/releases/v1.1.6/AGENTFLOW_V1_1_6_EXECUTOR_ADAPTER_REAL_EXECUTION_TASKS_V1.md").read_text(encoding="utf-8")

checks = {
    "all-v116-artifacts-passed": all(payload.get("status") == "passed" for payload in artifacts),
    "release-version-v116": release_version in {"v1.1.6", "v1.1.7", "v1.1.8", "v1.1.9", "v1.2.0", "v1.2.1", "v1.2.2", "v1.2.3", "v1.2.4", "v1.2.5", "v1.2.6", "v1.2.7", "v1.2.8", "v1.2.9"} and release_tag in {"v1.1.6", "v1.1.7", "v1.1.8", "v1.1.9", "v1.2.0", "v1.2.1", "v1.2.2", "v1.2.3", "v1.2.4", "v1.2.5", "v1.2.6", "v1.2.7", "v1.2.8", "v1.2.9"},
    "workspace-version-v116": cargo_version in {"1.1.6", "1.1.7", "1.1.8", "1.1.9", "1.2.0", "1.2.1", "1.2.2", "1.2.3", "1.2.4", "1.2.5", "1.2.6", "1.2.7", "1.2.8", "1.2.9"},
    "desktop-package-version-v116": package_json.get("version") in {"1.1.6", "1.1.7", "1.1.8", "1.1.9", "1.2.0", "1.2.1", "1.2.2", "1.2.3", "1.2.4", "1.2.5", "1.2.6", "1.2.7", "1.2.8", "1.2.9"},
    "desktop-lock-version-v116": package_lock.get("version") in {"1.1.6", "1.1.7", "1.1.8", "1.1.9", "1.2.0", "1.2.1", "1.2.2", "1.2.3", "1.2.4", "1.2.5", "1.2.6", "1.2.7", "1.2.8", "1.2.9"} and package_lock.get("packages", {}).get("", {}).get("version") in {"1.1.6", "1.1.7", "1.1.8", "1.1.9", "1.2.0", "1.2.1", "1.2.2", "1.2.3", "1.2.4", "1.2.5", "1.2.6", "1.2.7", "1.2.8", "1.2.9"},
    "tauri-version-v116": tauri.get("version") in {"1.1.6", "1.1.7", "1.1.8", "1.1.9", "1.2.0", "1.2.1", "1.2.2", "1.2.3", "1.2.4", "1.2.5", "1.2.6", "1.2.7", "1.2.8", "1.2.9"},
    ...
    "clarify-research-safe-next-actions-proof": artifacts[1].get("coverage", {}).get("clarify-research-safe-actions") is True and artifacts[1].get("coverage", {}).get("no-authority-materialization-rejected") is True,
    "desktop-bridge-proof": artifacts[2].get("coverage", {}).get("all-commands-registered") is True,
    "handoff-proof": artifacts[3].get("coverage", {}).get("handoff-file-written") is True and artifacts[3].get("coverage", {}).get("handoff-session-not-authority") is True,
    "boundary-proof": artifacts[4].get("coverage", {}).get("out-of-scope-diff-fails") is True,
    "evidence-proof": artifacts[5].get("coverage", {}).get("evidence-status-passed") is True,
    "writeback-proof": artifacts[6].get("coverage", {}).get("issue-status-done") is True and artifacts[6].get("coverage", {}).get("run-status-completed") is True,
    "failure-retry-proof": artifacts[7].get("coverage", {}).get("retry-creates-new-run") is True and artifacts[7].get("coverage", {}).get("timeout-blocks-current-run") is True,
    "software-dev-golden-path-proof": artifacts[8].get("coverage", {}).get("product-mapping-is-software-dev") is True and artifacts[8].get("status") == "passed",
}
failed = [key for key, passed in checks.items() if not passed]
certification = load_json(certification_path)
certification["releaseGateMetadata"] = {
...
certification_path.write_text(json.dumps(certification, ensure_ascii=False, indent=2) + "\n", encoding="utf-8")
if certification["status"] != "passed":
    raise SystemExit(f"v116 release certification failed: {failed}")
PY

  record_stage "v116-next-release-authority-alignment" "passed" "$(basename "$V116_NEXT_RELEASE_AUTHORITY_ALIGNMENT_PATH")"
  record_stage "v116-core-route-next-action-semantics" "passed" "$(basename "$V116_CORE_ROUTE_NEXT_ACTION_SEMANTICS_PATH")"
  record_stage "v116-product-spec-intake-desktop-invocation-bridge" "passed" "$(basename "$V116_PRODUCT_SPEC_INTAKE_DESKTOP_INVOCATION_BRIDGE_PATH")"
  record_stage "v116-executor-adapter-handoff-package" "passed" "$(basename "$V116_EXECUTOR_ADAPTER_HANDOFF_PACKAGE_PATH")"
  record_stage "v116-allowed-surface-diff-boundary-check" "passed" "$(basename "$V116_ALLOWED_SURFACE_DIFF_BOUNDARY_CHECK_PATH")"
  record_stage "v116-executor-evidence-capture" "passed" "$(basename "$V116_EXECUTOR_EVIDENCE_CAPTURE_PATH")"
  record_stage "v116-executor-result-issue-run-writeback" "passed" "$(basename "$V116_EXECUTOR_RESULT_ISSUE_RUN_WRITEBACK_PATH")"
  record_stage "v116-failure-timeout-cancel-retry-semantics" "passed" "$(basename "$V116_FAILURE_TIMEOUT_CANCEL_RETRY_SEMANTICS_PATH")"
  record_stage "v116-software-dev-real-executor-golden-path" "passed" "$(basename "$V116_SOFTWARE_DEV_REAL_EXECUTOR_GOLDEN_PATH_PATH")"
  record_stage "v116-release-certification" "passed" "$(basename "$V116_RELEASE_CERTIFICATION_PATH")"
}

run_v117_release_certification_gate() {
  record_stage "v117-release-certification" "started" "$V117_RELEASE_CERTIFICATION_PATH"

  git -C "$WORKSPACE" checkout -B "$BOOTSTRAP_BRANCH" "$SOURCE_COMMIT_SHA" >/dev/null
  git -C "$WORKSPACE" reset --hard "$SOURCE_COMMIT_SHA" >/dev/null
  git -C "$WORKSPACE" clean -fdx >/dev/null

  cargo run -p agentflow-runtime-api --example v117_executor_readability_proofs --manifest-path "$WORKSPACE/Cargo.toml" -- \
    "$WORKSPACE" \
    "$V117_NEXT_RELEASE_PLANNING_SURFACE_CONTRACT_PATH" \
    "$V117_EXECUTOR_SURFACE_PATH_VALIDATION_HARDENING_PATH" \
    "$V117_DESKTOP_EXECUTOR_FLOW_READ_MODEL_PATH" \
    "$V117_EVIDENCE_GRAPH_USER_READABLE_PROJECTION_PATH" \
    "$V117_DECISION_REASON_REMEDIATION_PROJECTION_PATH" \
    "$V117_DELIVERY_PACKAGE_READABILITY_CONTRACT_PATH" \
    "$V117_FAILURE_NEEDS_FIX_DEFERRED_REPAIR_PATHS_PATH" \
    "$V117_PORTABLE_LOCAL_DIAGNOSTIC_BOUNDARY_PATH" \
    "$V117_RELEASE_CERTIFICATION_SCHEMA_HARDENING_PATH" \
    "$V117_RELEASE_CERTIFICATION_PATH" >/dev/null

  python3 - "$WORKSPACE" "$RELEASE_VERSION" "$RELEASE_TAG_NAME" \
    "$GATE_RUN_ID" "$SOURCE_COMMIT_SHA" \
    "$V117_NEXT_RELEASE_PLANNING_SURFACE_CONTRACT_PATH" \
    "$V117_EXECUTOR_SURFACE_PATH_VALIDATION_HARDENING_PATH" \
    "$V117_DESKTOP_EXECUTOR_FLOW_READ_MODEL_PATH" \
    "$V117_EVIDENCE_GRAPH_USER_READABLE_PROJECTION_PATH" \
    ...
    "$V117_PORTABLE_LOCAL_DIAGNOSTIC_BOUNDARY_PATH" \
    "$V117_RELEASE_CERTIFICATION_SCHEMA_HARDENING_PATH" \
    "$V117_RELEASE_CERTIFICATION_PATH" <<'PY'
import json
import pathlib
import sys
import tomllib
...
docs_readme = (root / "docs/README.md").read_text(encoding="utf-8")
agents = (root / "AGENTS.md").read_text(encoding="utf-8")
release_readme = (root / "docs/delivery/releases/v1.1.7/README.md").read_text(encoding="utf-8")
release_tasks = (root / "docs/delivery/releases/v1.1.7/AGENTFLOW_V1_1_7_EVIDENCE_DECISION_DELIVERY_READABILITY_TASKS_V1.md").read_text(encoding="utf-8")
schema = load_json(schema_path)
certification = load_json(certification_path)
primary_proofs = schema.get("payload", {}).get("primaryProofs", [])
primary_file_names = {path.name for path in artifact_paths[:-2]}

checks = {
    "all-v117-artifacts-passed": all(payload.get("status") == "passed" for payload in artifacts),
    "release-version-v117": release_version in {"v1.1.7", "v1.1.8", "v1.1.9", "v1.2.0", "v1.2.1", "v1.2.2", "v1.2.3", "v1.2.4", "v1.2.5", "v1.2.6", "v1.2.7", "v1.2.8", "v1.2.9"} and release_tag in {"v1.1.7", "v1.1.8", "v1.1.9", "v1.2.0", "v1.2.1", "v1.2.2", "v1.2.3", "v1.2.4", "v1.2.5", "v1.2.6", "v1.2.7", "v1.2.8", "v1.2.9"},
    "workspace-version-v117": cargo_version in {"1.1.7", "1.1.8", "1.1.9", "1.2.0", "1.2.1", "1.2.2", "1.2.3", "1.2.4", "1.2.5", "1.2.6", "1.2.7", "1.2.8", "1.2.9"},
    "desktop-package-version-v117": package_json.get("version") in {"1.1.7", "1.1.8", "1.1.9", "1.2.0", "1.2.1", "1.2.2", "1.2.3", "1.2.4", "1.2.5", "1.2.6", "1.2.7", "1.2.8", "1.2.9"},
    "desktop-lock-version-v117": package_lock.get("version") in {"1.1.7", "1.1.8", "1.1.9", "1.2.0", "1.2.1", "1.2.2", "1.2.3", "1.2.4", "1.2.5", "1.2.6", "1.2.7", "1.2.8", "1.2.9"} and package_lock.get("packages", {}).get("", {}).get("version") in {"1.1.7", "1.1.8", "1.1.9", "1.2.0", "1.2.1", "1.2.2", "1.2.3", "1.2.4", "1.2.5", "1.2.6", "1.2.7", "1.2.8", "1.2.9"},
    "tauri-version-v117": tauri.get("version") in {"1.1.7", "1.1.8", "1.1.9", "1.2.0", "1.2.1", "1.2.2", "1.2.3", "1.2.4", "1.2.5", "1.2.6", "1.2.7", "1.2.8", "1.2.9"},
    ...
    "desktop-read-model-proof": artifacts[2].get("coverage", {}).get("runtime-command-registered") is True,
    "evidence-graph-proof": artifacts[3].get("coverage", {}).get("graph-has-nodes-and-links") is True,
    "decision-proof": artifacts[4].get("coverage", {}).get("non-accepted-remediation-visible") is True,
    "delivery-proof": artifacts[5].get("coverage", {}).get("accepted-delivery-ready") is True,
    "repair-proof": artifacts[6].get("coverage", {}).get("repair-actions-visible") is True,
    "portable-proof": artifacts[7].get("coverage", {}).get("local-diagnostics-marked-local-only") is True,
    "schema-primary-proofs-present": all(pathlib.Path(proof).name in primary_file_names for proof in primary_proofs),
}
failed = [key for key, passed in checks.items() if not passed]
certification["releaseGateMetadata"] = {
    "releaseVersion": release_version,
...
certification_path.write_text(json.dumps(certification, ensure_ascii=False, indent=2) + "\n", encoding="utf-8")
if certification["status"] != "passed":
    raise SystemExit(f"v117 release certification failed: {failed}")
PY

  record_stage "v117-next-release-planning-surface-contract" "passed" "$(basename "$V117_NEXT_RELEASE_PLANNING_SURFACE_CONTRACT_PATH")"
  record_stage "v117-executor-surface-path-validation-hardening" "passed" "$(basename "$V117_EXECUTOR_SURFACE_PATH_VALIDATION_HARDENING_PATH")"
  record_stage "v117-desktop-executor-flow-read-model" "passed" "$(basename "$V117_DESKTOP_EXECUTOR_FLOW_READ_MODEL_PATH")"
  record_stage "v117-evidence-graph-user-readable-projection" "passed" "$(basename "$V117_EVIDENCE_GRAPH_USER_READABLE_PROJECTION_PATH")"
  record_stage "v117-decision-reason-remediation-projection" "passed" "$(basename "$V117_DECISION_REASON_REMEDIATION_PROJECTION_PATH")"
  record_stage "v117-delivery-package-readability-contract" "passed" "$(basename "$V117_DELIVERY_PACKAGE_READABILITY_CONTRACT_PATH")"
  record_stage "v117-failure-needs-fix-deferred-repair-paths" "passed" "$(basename "$V117_FAILURE_NEEDS_FIX_DEFERRED_REPAIR_PATHS_PATH")"
  record_stage "v117-portable-local-diagnostic-boundary" "passed" "$(basename "$V117_PORTABLE_LOCAL_DIAGNOSTIC_BOUNDARY_PATH")"
  record_stage "v117-release-certification-schema-hardening" "passed" "$(basename "$V117_RELEASE_CERTIFICATION_SCHEMA_HARDENING_PATH")"
  record_stage "v117-release-certification" "passed" "$(basename "$V117_RELEASE_CERTIFICATION_PATH")"
}

run_v118_release_certification_gate() {
  record_stage "v118-release-certification" "started" "$V118_RELEASE_CERTIFICATION_PATH"

  git -C "$WORKSPACE" checkout -B "$BOOTSTRAP_BRANCH" "$SOURCE_COMMIT_SHA" >/dev/null
  git -C "$WORKSPACE" reset --hard "$SOURCE_COMMIT_SHA" >/dev/null
  git -C "$WORKSPACE" clean -fdx >/dev/null

  cargo run -p agentflow-runtime-api --example v118_recovery_resume_failure_proofs --manifest-path "$WORKSPACE/Cargo.toml" -- \
    "$WORKSPACE" \
    "$V118_RELEASE_CLOSEOUT_CERTIFICATION_METADATA_HARDENING_PATH" \
    "$V118_EVIDENCE_GRAPH_COMPLETION_PROOF_TIGHTENING_PATH" \
    "$V118_DESKTOP_EXECUTOR_FLOW_FRONTEND_INVOCATION_PATH" \
    "$V118_RUN_RESUME_CONTRACT_PATH" \
    "$V118_FAILED_COMMAND_RECOVERY_PATH" \
    "$V118_INTERRUPTED_EXECUTOR_SESSION_CLOSEOUT_PATH" \
    "$V118_DUPLICATE_COMMAND_IDEMPOTENCY_HANDLING_PATH" \
    "$V118_STALE_PROJECTION_REBUILD_RECOVERY_PATH" \
    "$V118_WORKSPACE_HEALTH_CHECK_PATH" \
    "$V118_RELEASE_CERTIFICATION_PATH" >/dev/null
  ...
  python3 - "$WORKSPACE" "$RELEASE_VERSION" "$RELEASE_TAG_NAME" \
    ...
    "$V118_STALE_PROJECTION_REBUILD_RECOVERY_PATH" \
    "$V118_WORKSPACE_HEALTH_CHECK_PATH" \
    "$V118_RELEASE_CERTIFICATION_PATH" <<'PY'
import json
import pathlib
import sys
import tomllib
...
docs_readme = (root / "docs/README.md").read_text(encoding="utf-8")
agents = (root / "AGENTS.md").read_text(encoding="utf-8")
release_readme = (root / "docs/delivery/releases/v1.1.8/README.md").read_text(encoding="utf-8")
release_tasks = (root / "docs/delivery/releases/v1.1.8/AGENTFLOW_V1_1_8_RECOVERY_RESUME_FAILURE_HANDLING_TASKS_V1.md").read_text(encoding="utf-8")
certification = load_json(certification_path)
primary_proofs = certification.get("payload", {}).get("primaryProofs", [])
primary_file_names = {path.name for path in artifact_paths[:-1]}

checks = {
    "all-v118-artifacts-passed": all(payload.get("status") == "passed" for payload in artifacts),
    "release-version-v118": release_version in {"v1.1.8", "v1.1.9", "v1.2.0", "v1.2.1", "v1.2.2", "v1.2.3", "v1.2.4", "v1.2.5", "v1.2.6", "v1.2.7", "v1.2.8", "v1.2.9"} and release_tag in {"v1.1.8", "v1.1.9", "v1.2.0", "v1.2.1", "v1.2.2", "v1.2.3", "v1.2.4", "v1.2.5", "v1.2.6", "v1.2.7", "v1.2.8", "v1.2.9"},
    "workspace-version-v118": cargo_version in {"1.1.8", "1.1.9", "1.2.0", "1.2.1", "1.2.2", "1.2.3", "1.2.4", "1.2.5", "1.2.6", "1.2.7", "1.2.8", "1.2.9"},
    "desktop-package-version-v118": package_json.get("version") in {"1.1.8", "1.1.9", "1.2.0", "1.2.1", "1.2.2", "1.2.3", "1.2.4", "1.2.5", "1.2.6", "1.2.7", "1.2.8", "1.2.9"},
    "desktop-lock-version-v118": package_lock.get("version") in {"1.1.8", "1.1.9", "1.2.0", "1.2.1", "1.2.2", "1.2.3", "1.2.4", "1.2.5", "1.2.6", "1.2.7", "1.2.8", "1.2.9"} and package_lock.get("packages", {}).get("", {}).get("version") in {"1.1.8", "1.1.9", "1.2.0", "1.2.1", "1.2.2", "1.2.3", "1.2.4", "1.2.5", "1.2.6", "1.2.7", "1.2.8", "1.2.9"},
    "tauri-version-v118": tauri.get("version") in {"1.1.8", "1.1.9", "1.2.0", "1.2.1", "1.2.2", "1.2.3", "1.2.4", "1.2.5", "1.2.6", "1.2.7", "1.2.8", "1.2.9"},
    ...
    "evidence-graph-proof": artifacts[1].get("coverage", {}).get("complete-requires-all-nodes") is True and artifacts[1].get("coverage", {}).get("partial-is-not-complete") is True,
    "desktop-invocation-proof": artifacts[2].get("coverage", {}).get("frontend-invokes-runtime-api") is True,
    "resume-proof": artifacts[3].get("coverage", {}).get("resume-creates-new-run") is True,
    "failed-command-proof": artifacts[4].get("coverage", {}).get("original-failed-evidence-preserved") is True,
    "interrupted-proof": artifacts[5].get("coverage", {}).get("interrupt-does-not-mark-done") is True,
    "idempotency-proof": artifacts[6].get("coverage", {}).get("same-payload-reuses-existing-receipt") is True,
    "projection-rebuild-proof": artifacts[7].get("coverage", {}).get("missing-events-do-not-fake-freshness") is True,
    "workspace-health-proof": artifacts[8].get("coverage", {}).get("missing-authority-blocks-health") is True,
...
certification_path.write_text(json.dumps(certification, ensure_ascii=False, indent=2) + "\n", encoding="utf-8")
if certification["status"] != "passed":
    raise SystemExit(f"v118 release certification failed: {failed}")
PY

  record_stage "v118-release-closeout-certification-metadata-hardening" "passed" "$(basename "$V118_RELEASE_CLOSEOUT_CERTIFICATION_METADATA_HARDENING_PATH")"
  record_stage "v118-evidence-graph-completion-proof-tightening" "passed" "$(basename "$V118_EVIDENCE_GRAPH_COMPLETION_PROOF_TIGHTENING_PATH")"
  record_stage "v118-desktop-executor-flow-frontend-invocation" "passed" "$(basename "$V118_DESKTOP_EXECUTOR_FLOW_FRONTEND_INVOCATION_PATH")"
  record_stage "v118-run-resume-contract" "passed" "$(basename "$V118_RUN_RESUME_CONTRACT_PATH")"
  record_stage "v118-failed-command-recovery" "passed" "$(basename "$V118_FAILED_COMMAND_RECOVERY_PATH")"
  record_stage "v118-interrupted-executor-session-closeout" "passed" "$(basename "$V118_INTERRUPTED_EXECUTOR_SESSION_CLOSEOUT_PATH")"
  record_stage "v118-duplicate-command-idempotency-handling" "passed" "$(basename "$V118_DUPLICATE_COMMAND_IDEMPOTENCY_HANDLING_PATH")"
  record_stage "v118-stale-projection-rebuild-recovery" "passed" "$(basename "$V118_STALE_PROJECTION_REBUILD_RECOVERY_PATH")"
  record_stage "v118-workspace-health-check" "passed" "$(basename "$V118_WORKSPACE_HEALTH_CHECK_PATH")"
  record_stage "v118-release-certification" "passed" "$(basename "$V118_RELEASE_CERTIFICATION_PATH")"
}

run_v119_release_certification_gate() {
  record_stage "v119-release-certification" "started" "$V119_BETA_RELEASE_CERTIFICATION_PATH"

  git -C "$WORKSPACE" checkout -B "$BOOTSTRAP_BRANCH" "$SOURCE_COMMIT_SHA" >/dev/null
  git -C "$WORKSPACE" reset --hard "$SOURCE_COMMIT_SHA" >/dev/null
  git -C "$WORKSPACE" clean -fdx >/dev/null

  cargo run -p agentflow-runtime-api --example v119_software_dev_beta_certification_proofs --manifest-path "$WORKSPACE/Cargo.toml" -- \
    "$WORKSPACE" \
    "$V119_RELEASE_CERTIFICATION_METADATA_TOP_LEVEL_CONTRACT_PATH" \
    "$V119_RECOVERY_IDEMPOTENCY_RECEIPT_PATH_HARDENING_PATH" \
    "$V119_PROJECTION_REBUILD_POSITIVE_RECOVERY_PROOF_PATH" \
    "$V119_WORKSPACE_HEALTH_PROVIDER_SKILL_SMOKE_BOUNDARY_PATH" \
    "$V119_SOFTWARE_DEV_REFERENCE_APP_BETA_SCOPE_ALIGNMENT_PATH" \
    "$V119_E2E_PROJECT_INTAKE_TASKS_GOLDEN_SCENARIO_PATH" \
    "$V119_EXECUTOR_RUN_EVIDENCE_DECISION_DELIVERY_GOLDEN_PATH" \
    "$V119_FAILURE_RETRY_FEEDBACK_BETA_SCENARIO_PATH" \
    "$V119_DESKTOP_BETA_READINESS_UI_SMOKE_PROOF_PATH" \
    "$V119_BETA_RELEASE_CERTIFICATION_PATH" >/dev/null
  ...
  python3 - "$WORKSPACE" "$RELEASE_VERSION" "$RELEASE_TAG_NAME" \
    ...
    "$V119_FAILURE_RETRY_FEEDBACK_BETA_SCENARIO_PATH" \
    "$V119_DESKTOP_BETA_READINESS_UI_SMOKE_PROOF_PATH" \
    "$V119_BETA_RELEASE_CERTIFICATION_PATH" <<'PY'
import json
import pathlib
import sys
import tomllib
...
docs_readme = (root / "docs/README.md").read_text(encoding="utf-8")
agents = (root / "AGENTS.md").read_text(encoding="utf-8")
release_readme = (root / "docs/delivery/releases/v1.1.9/README.md").read_text(encoding="utf-8")
release_tasks = (root / "docs/delivery/releases/v1.1.9/AGENTFLOW_V1_1_9_SOFTWARE_DEV_REFERENCE_APP_BETA_CERTIFICATION_TASKS_V1.md").read_text(encoding="utf-8")
certification = load_json(certification_path)
primary_proofs = certification.get("payload", {}).get("primaryProofs", [])
primary_file_names = {path.name for path in artifact_paths[:-1]}
...
checks = {
    ...
    "release-version-v119": release_version in {"v1.1.9", "v1.2.0", "v1.2.1", "v1.2.2", "v1.2.3", "v1.2.4", "v1.2.5", "v1.2.6", "v1.2.7", "v1.2.8", "v1.2.9"} and release_tag in {"v1.1.9", "v1.2.0", "v1.2.1", "v1.2.2", "v1.2.3", "v1.2.4", "v1.2.5", "v1.2.6", "v1.2.7", "v1.2.8", "v1.2.9"},
    "workspace-version-v119": cargo_version in {"1.1.9", "1.2.0", "1.2.1", "1.2.2", "1.2.3", "1.2.4", "1.2.5", "1.2.6", "1.2.7", "1.2.8", "1.2.9"},
    "desktop-package-version-v119": package_json.get("version") in {"1.1.9", "1.2.0", "1.2.1", "1.2.2", "1.2.3", "1.2.4", "1.2.5", "1.2.6", "1.2.7", "1.2.8", "1.2.9"},
    "desktop-lock-version-v119": package_lock.get("version") in {"1.1.9", "1.2.0", "1.2.1", "1.2.2", "1.2.3", "1.2.4", "1.2.5", "1.2.6", "1.2.7", "1.2.8", "1.2.9"} and package_lock.get("packages", {}).get("", {}).get("version") in {"1.1.9", "1.2.0", "1.2.1", "1.2.2", "1.2.3", "1.2.4", "1.2.5", "1.2.6", "1.2.7", "1.2.8", "1.2.9"},
    "tauri-version-v119": tauri.get("version") in {"1.1.9", "1.2.0", "1.2.1", "1.2.2", "1.2.3", "1.2.4", "1.2.5", "1.2.6", "1.2.7", "1.2.8", "1.2.9"},
    ...
    "idempotency-proof": artifacts[1].get("coverage", {}).get("same-path-different-key-rejected") is True and artifacts[1].get("coverage", {}).get("same-path-missing-key-rejected") is True,
    "projection-positive-proof": artifacts[2].get("coverage", {}).get("event-backed-rebuild-is-fresh") is True and artifacts[2].get("coverage", {}).get("missing-events-fail") is True,
    "workspace-health-proof": artifacts[3].get("coverage", {}).get("provider-name-alone-is-not-ready") is True and artifacts[3].get("coverage", {}).get("provider-and-skill-smoke-ready") is True,
    "beta-scope-proof": artifacts[4].get("coverage", {}).get("not-core-product-ga") is True,
    "golden-intake-proof": artifacts[5].get("coverage", {}).get("projection-from-intake-event") is True,
    "golden-executor-proof": artifacts[6].get("coverage", {}).get("delivery-ready") is True,
    "failure-retry-proof": artifacts[7].get("coverage", {}).get("feedback-does-not-mark-done") is True,
    "desktop-smoke-proof": artifacts[8].get("coverage", {}).get("desktop-uses-runtime-api") is True,
    "primary-proofs-present": all(pathlib.Path(proof).name in primary_file_names for proof in primary_proofs),
}
failed = [key for key, passed in checks.items() if not passed]
certification["releaseGateMetadata"] = {
...
certification_path.write_text(json.dumps(certification, ensure_ascii=False, indent=2) + "\n", encoding="utf-8")
if certification["status"] != "passed":
    raise SystemExit(f"v119 release certification failed: {failed}")
PY

  record_stage "v119-release-certification-metadata-top-level-contract" "passed" "$(basename "$V119_RELEASE_CERTIFICATION_METADATA_TOP_LEVEL_CONTRACT_PATH")"
  record_stage "v119-recovery-idempotency-receipt-path-hardening" "passed" "$(basename "$V119_RECOVERY_IDEMPOTENCY_RECEIPT_PATH_HARDENING_PATH")"
  record_stage "v119-projection-rebuild-positive-recovery-proof" "passed" "$(basename "$V119_PROJECTION_REBUILD_POSITIVE_RECOVERY_PROOF_PATH")"
  record_stage "v119-workspace-health-provider-skill-smoke-boundary" "passed" "$(basename "$V119_WORKSPACE_HEALTH_PROVIDER_SKILL_SMOKE_BOUNDARY_PATH")"
  record_stage "v119-software-dev-reference-app-beta-scope-alignment" "passed" "$(basename "$V119_SOFTWARE_DEV_REFERENCE_APP_BETA_SCOPE_ALIGNMENT_PATH")"
  record_stage "v119-e2e-project-intake-tasks-golden-scenario" "passed" "$(basename "$V119_E2E_PROJECT_INTAKE_TASKS_GOLDEN_SCENARIO_PATH")"
  record_stage "v119-executor-run-evidence-decision-delivery-golden-path" "passed" "$(basename "$V119_EXECUTOR_RUN_EVIDENCE_DECISION_DELIVERY_GOLDEN_PATH")"
  record_stage "v119-failure-retry-feedback-beta-scenario" "passed" "$(basename "$V119_FAILURE_RETRY_FEEDBACK_BETA_SCENARIO_PATH")"
  record_stage "v119-desktop-beta-readiness-ui-smoke-proof" "passed" "$(basename "$V119_DESKTOP_BETA_READINESS_UI_SMOKE_PROOF_PATH")"
  record_stage "v119-release-certification" "passed" "$(basename "$V119_BETA_RELEASE_CERTIFICATION_PATH")"
}

run_v120_release_certification_gate() {
  record_stage "v120-release-certification" "started" "$V120_RELEASE_CERTIFICATION_PATH"
  ...
  cargo run -p agentflow-runtime-api --example v120_product_onboarding_first_run_proofs --manifest-path "$WORKSPACE/Cargo.toml" -- \
    "$WORKSPACE" \
    "$V120_RELEASE_CERTIFICATION_TOP_LEVEL_METADATA_PATH" \
    "$V120_CERTIFICATION_ARTIFACT_MANIFEST_PRIMARY_PROOF_INDEX_PATH" \
    "$V120_FIRST_RUN_PRODUCT_ONBOARDING_CONTRACT_PATH" \
    "$V120_PRODUCT_SELECTION_WORKSPACE_BOOTSTRAP_PATH" \
    "$V120_WORKSPACE_READINESS_PREFLIGHT_PATH" \
    "$V120_PROVIDER_CONNECTOR_SKILL_READINESS_PATH" \
    "$V120_GUIDED_SAMPLE_PROJECT_GOLDEN_RUN_PATH" \
    "$V120_DESKTOP_FIRST_RUN_ONBOARDING_SURFACE_PATH" \
    "$V120_USER_HIDDEN_AGENTFLOW_BOUNDARY_PATH" \
    "$V120_RELEASE_CERTIFICATION_PATH" >/dev/null
  ...
  python3 - "$WORKSPACE" "$RELEASE_VERSION" "$RELEASE_TAG_NAME" \
    ...
    "$V120_DESKTOP_FIRST_RUN_ONBOARDING_SURFACE_PATH" \
    "$V120_USER_HIDDEN_AGENTFLOW_BOUNDARY_PATH" \
    "$V120_RELEASE_CERTIFICATION_PATH" <<'PY'
import json
import pathlib
import sys
import tomllib
...
docs_readme = (root / "docs/README.md").read_text(encoding="utf-8")
agents = (root / "AGENTS.md").read_text(encoding="utf-8")
release_readme = (root / "docs/delivery/releases/v1.2.0/README.md").read_text(encoding="utf-8")
release_tasks = (root / "docs/delivery/releases/v1.2.0/AGENTFLOW_V1_2_0_PRODUCT_ONBOARDING_FIRST_RUN_TASKS_V1.md").read_text(encoding="utf-8")
certification = load_json(certification_path)
...
checks = {
    ...
    "release-version-v120": release_version in {"v1.2.0", "v1.2.1", "v1.2.2", "v1.2.3", "v1.2.4", "v1.2.5", "v1.2.6", "v1.2.7", "v1.2.8", "v1.2.9"} and release_tag in {"v1.2.0", "v1.2.1", "v1.2.2", "v1.2.3", "v1.2.4", "v1.2.5", "v1.2.6", "v1.2.7", "v1.2.8", "v1.2.9"},
    "workspace-version-v120": cargo_version in {"1.2.0", "1.2.1", "1.2.2", "1.2.3", "1.2.4", "1.2.5", "1.2.6", "1.2.7", "1.2.8", "1.2.9"},
    "desktop-package-version-v120": package_json.get("version") in {"1.2.0", "1.2.1", "1.2.2", "1.2.3", "1.2.4", "1.2.5", "1.2.6", "1.2.7", "1.2.8", "1.2.9"},
    "desktop-lock-version-v120": package_lock.get("version") in {"1.2.0", "1.2.1", "1.2.2", "1.2.3", "1.2.4", "1.2.5", "1.2.6", "1.2.7", "1.2.8", "1.2.9"} and package_lock.get("packages", {}).get("", {}).get("version") in {"1.2.0", "1.2.1", "1.2.2", "1.2.3", "1.2.4", "1.2.5", "1.2.6", "1.2.7", "1.2.8", "1.2.9"},
    "tauri-version-v120": tauri.get("version") in {"1.2.0", "1.2.1", "1.2.2", "1.2.3", "1.2.4", "1.2.5", "1.2.6", "1.2.7", "1.2.8", "1.2.9"},
    ...
    "primary-proofs-present": all(pathlib.Path(proof).name in primary_file_names for proof in primary_proofs),
    "manifest-primary-proof-index": bool(manifest_index) and all(item.get("sha256") and item.get("bytes", 0) > 0 and item.get("proofRole") for item in manifest_index),
    "metadata-proof": artifacts[0].get("coverage", {}).get("release-metadata-top-level-fields-present") is True and artifacts[0].get("coverage", {}).get("mismatched-metadata-negative-check-rejects") is True,
    "first-run-contract-proof": artifacts[2].get("coverage", {}).get("required-states-present") is True and artifacts[2].get("coverage", {}).get("agentflow-hidden-from-user") is True,
    "product-bootstrap-proof": artifacts[3].get("coverage", {}).get("software-dev-product-creates-workspace") is True and artifacts[3].get("coverage", {}).get("missing-product-is-rejected") is True,
    "workspace-readiness-proof": artifacts[4].get("coverage", {}).get("ready-after-all-evidence") is True,
    "provider-skill-proof": artifacts[5].get("coverage", {}).get("provider-name-alone-not-ready") is True and artifacts[5].get("coverage", {}).get("provider-connector-skill-ready") is True,
    "guided-sample-proof": artifacts[6].get("coverage", {}).get("sample-covers-intake-tasks-execute-evidence-delivery-feedback") is True,
    "desktop-first-run-proof": artifacts[7].get("coverage", {}).get("desktop-uses-product-onboarding-read-model-marker") is True and artifacts[7].get("coverage", {}).get("runtime-commands-registered") is True,
    "hidden-boundary-proof": artifacts[8].get("coverage", {}).get("contract-hides-agentflow-from-normal-users") is True,
}
failed = [key for key, passed in checks.items() if not passed]
certification["releaseGateMetadata"] = {
    "releaseVersion": release_version,
...
certification_path.write_text(json.dumps(certification, ensure_ascii=False, indent=2) + "\n", encoding="utf-8")
if certification["status"] != "passed":
    raise SystemExit(f"v120 release certification failed: {failed}")
PY

  record_stage "v120-release-certification-top-level-metadata" "passed" "$(basename "$V120_RELEASE_CERTIFICATION_TOP_LEVEL_METADATA_PATH")"
  record_stage "v120-certification-artifact-manifest-primary-proof-index" "passed" "$(basename "$V120_CERTIFICATION_ARTIFACT_MANIFEST_PRIMARY_PROOF_INDEX_PATH")"
  record_stage "v120-first-run-product-onboarding-contract" "passed" "$(basename "$V120_FIRST_RUN_PRODUCT_ONBOARDING_CONTRACT_PATH")"
  record_stage "v120-product-selection-workspace-bootstrap" "passed" "$(basename "$V120_PRODUCT_SELECTION_WORKSPACE_BOOTSTRAP_PATH")"
  record_stage "v120-workspace-readiness-preflight" "passed" "$(basename "$V120_WORKSPACE_READINESS_PREFLIGHT_PATH")"
  record_stage "v120-provider-connector-skill-readiness" "passed" "$(basename "$V120_PROVIDER_CONNECTOR_SKILL_READINESS_PATH")"
  record_stage "v120-guided-sample-project-golden-run" "passed" "$(basename "$V120_GUIDED_SAMPLE_PROJECT_GOLDEN_RUN_PATH")"
  record_stage "v120-desktop-first-run-onboarding-surface" "passed" "$(basename "$V120_DESKTOP_FIRST_RUN_ONBOARDING_SURFACE_PATH")"
  record_stage "v120-user-hidden-agentflow-boundary" "passed" "$(basename "$V120_USER_HIDDEN_AGENTFLOW_BOUNDARY_PATH")"
...
run_v121_release_certification_gate() {
  ...
  cargo run -p agentflow-runtime-api --example v121_first_run_team_workflow_proofs --manifest-path "$WORKSPACE/Cargo.toml" -- \
    ...
    "$V122_RELEASE_CERTIFICATION_PATH" >/dev/null
...
changelog = (root / "CHANGELOG.md").read_text(encoding="utf-8")
delivery = (root / "docs/delivery/README.md").read_text(encoding="utf-8")
v121_release_readme = (root / "docs/delivery/releases/v1.2.1/README.md").read_text(encoding="utf-8")
v121_release_tasks = (root / "docs/delivery/releases/v1.2.1/AGENTFLOW_V1_2_1_FIRST_RUN_TEAM_WORKFLOW_TASKS_V1.md").read_text(encoding="utf-8")
v122_release_readme = (root / "docs/delivery/releases/v1.2.2/README.md").read_text(encoding="utf-8")
v122_release_tasks = (root / "docs/delivery/releases/v1.2.2/AGENTFLOW_V1_2_2_RELEASE_PROOF_COMMERCIAL_BOUNDARY_TASKS_V1.md").read_text(encoding="utf-8")
certification = load_json(certification_path)
manifest = artifacts[1]
primary_proofs = certification.get("primaryProofs", [])
primary_file_names = {path.name for path in artifact_paths}
...
checks = {
    "all-release-artifacts-passed": all(payload.get("status") == "passed" for payload in artifacts),
    "release-version-at-or-after-v122": version_at_or_after(release_version, "v1.2.2") and version_at_or_after(release_tag, "v1.2.2"),
    "workspace-version-at-or-after-v122": version_at_or_after(cargo_version, "1.2.2"),
    "desktop-package-version-at-or-after-v122": version_at_or_after(package_json.get("version"), "1.2.2"),
    "desktop-lock-version-at-or-after-v122": version_at_or_after(package_lock.get("version"), "1.2.2") and version_at_or_after(package_lock.get("packages", {}).get("", {}).get("version"), "1.2.2"),
    "tauri-version-at-or-after-v122": version_at_or_after(tauri.get("version"), "1.2.2"),
    "changelog-current-v121": "## v1.2.1" in changelog and "First-run Execution Closure and Team Workflow Boundary" in changelog,
    "changelog-current-v122": "## v1.2.2" in changelog and "Release Proof Hardening and Commercial Boundary Preflight" in changelog,
    "delivery-v122-baseline-present": "releases/v1.2.2/README.md" in delivery,
    "release-readme-v121": "First-run Execution Closure and Team Workflow Boundary" in v121_release_readme,
    "release-readme-v122": "Release Proof Hardening and Commercial Boundary Preflight" in v122_release_readme,
    "release-tasks-v121-complete": all(f"#{issue}" in v121_release_tasks for issue in range(863, 873)),
    "release-tasks-v122-complete": all(f"#{issue}" in v122_release_tasks for issue in range(883, 893)),
    "certification-top-level-metadata": certification.get("releaseVersion") == release_version and certification.get("releaseTag") == release_tag and certification.get("sourceCommit") == source_commit and certification.get("workflowRunId") == workflow_run_id and bool(certification.get("artifactNames")) and bool(primary_proofs),
    "primary-proofs-present": all(pathlib.Path(proof).name in primary_file_names for proof in primary_proofs),
...
certification_path.write_text(json.dumps(certification, ensure_ascii=False, indent=2) + "\n", encoding="utf-8")
if certification["status"] != "passed":
    raise SystemExit(f"v122 release certification failed: {failed}")
PY
  ...
  record_stage "v122-release-certification" "passed" "$(basename "$V122_RELEASE_CERTIFICATION_PATH")"
}

run_v123_release_certification_gate() {
  local stage="release.v123-release-certification"
  local gate_run_id_for_cert="${GATE_RUN_ID:-local-workflow-run}"

  record_stage "$stage" "started" "$V123_RELEASE_CERTIFICATION_PATH"
  ...
  python3 - \
    ...
    "$SOURCE_COMMIT_SHA" \
    "$V123_RELEASE_CERTIFICATION_PATH" \
    "$LIVE_GITHUB_MILESTONE_CLOSEOUT_PATH" \
    "$RELEASE_CLOSEOUT_PROOF_NEGATIVE_FIXTURE_PATH" \
    "$V122_MILESTONE_CLOSEOUT_REPAIR_PATH" \
    "$V122_COMMERCIAL_PROOF_VERSION_NEGATIVE_FIXTURE_PATH" \
    "$V123_COMMERCIAL_PRODUCT_READ_MODEL_CONTRACT_PATH" \
    "$V123_PAID_REPORT_FLOW_PREFLIGHT_CONTRACT_PATH" \
    "$V123_MANAGED_PROJECT_FLOW_COMMERCIAL_BOUNDARY_PATH" \
    "$V123_DESKTOP_COMMERCIAL_BOUNDARY_SURFACE_PATH" \
    "$V123_COMMERCIAL_BOUNDARY_NEGATIVE_FIXTURES_PATH" <<'PY'
import json
import pathlib
import sys
import time
...
proofs = {path.name: load_json(path) for path in proof_paths if path.is_file()}
cargo_version = tomllib.loads((root / "Cargo.toml").read_text(encoding="utf-8"))["workspace"]["package"]["version"]
...
release_readme = (root / "docs/delivery/releases/v1.2.3/README.md").read_text(encoding="utf-8")
release_tasks = (root / "docs/delivery/releases/v1.2.3/AGENTFLOW_V1_2_3_RELEASE_CLOSEOUT_COMMERCIAL_TRACEABILITY_TASKS_V1.md").read_text(encoding="utf-8")

required_proof_paths = {
    "runtime/live-github-milestone-closeout.json",
    "runtime/release-closeout-proof-negative-fixture.json",
    "runtime/v122-milestone-closeout-repair.json",
    "runtime/v122-commercial-proof-version-negative-fixture.json",
    ...
    "runtime/v123-desktop-commercial-boundary-surface.json",
    "runtime/v123-commercial-boundary-negative-fixtures.json",
}
proof_by_relative_path = {
    f"runtime/{path.name}": proofs.get(path.name, {})
...
def proof_status(relative_path):
    return proof_by_relative_path.get(relative_path, {}).get("status")

def required_proof_passed(relative_path):
    status = proof_status(relative_path)
    if relative_path in {
        "runtime/live-github-milestone-closeout.json",
        "runtime/v122-milestone-closeout-repair.json",
    }:
        return status in {"passed", "waived", "deferred"}
    return status == "passed"

live_closeout = proof_by_relative_path.get("runtime/live-github-milestone-closeout.json", {})
negative_fixture = proof_by_relative_path.get("runtime/release-closeout-proof-negative-fixture.json", {})
read_model = proof_by_relative_path.get("runtime/v123-commercial-product-read-model-contract.json", {})
paid_report = proof_by_relative_path.get("runtime/v123-paid-report-flow-preflight-contract.json", {})
managed_project = proof_by_relative_path.get("runtime/v123-managed-project-flow-commercial-boundary.json", {})
desktop_surface = proof_by_relative_path.get("runtime/v123-desktop-commercial-boundary-surface.json", {})
negative_fixtures = proof_by_relative_path.get("runtime/v123-commercial-boundary-negative-fixtures.json", {})

checks = {
    "release-version-at-or-after-v123": version_at_or_after(release_version, "v1.2.3") and version_at_or_after(release_tag, "v1.2.3"),
    "workspace-version-at-or-after-v123": version_at_or_after(cargo_version, "1.2.3"),
    "cargo-lock-agentflow-packages-are-v123": all(
        version_at_or_after(package.get("version"), "1.2.3")
        for package in cargo_lock.get("package", [])
        if str(package.get("name", "")).startswith("agentflow-")
    ),
    "desktop-package-version-at-or-after-v123": version_at_or_after(package_json.get("version"), "1.2.3"),
    ...
    "required-primary-proofs-passed": all(required_proof_passed(path) for path in required_proof_paths),
    "live-closeout-provider-backed-or-prepublish": (
        live_closeout.get("decision", {}).get("providerBacked") is True
        or live_closeout.get("decision", {}).get("status") in {"waived", "deferred"}
    ),
    "self-assertion-negative-fixture-rejects": any(
        case.get("caseId") == "self-asserted-closed-milestone"
        and case.get("expected") == "rejected"
        and bool(case.get("failedCoverageKeys"))
        for case in negative_fixture.get("cases", [])
    ),
    "commercial-read-model-projection-only": read_model.get("coverage", {}).get("productSurfaceProjectionOnly") is True
    and read_model.get("coverage", {}).get("readModelNotCoreAuthority") is True,
    "paid-report-blocks-before-runtime": paid_report.get("coverage", {}).get("allowedStillRequiresRuntimeAdmission") is True
    and paid_report.get("coverage", {}).get("disabledEntitlementCannotStartRun") is True
    and paid_report.get("coverage", {}).get("missingReportDefinitionCannotStartRun") is True,
    "managed-project-keeps-core-authority": managed_project.get("coverage", {}).get("softwareDevMapsToManagedProject") is True
    and managed_project.get("coverage", {}).get("entitlementAffectsProductSurfaceOnly") is True
    and managed_project.get("coverage", {}).get("coreRuntimeIndustryNeutral") is True
    and managed_project.get("coverage", {}).get("negativeFixtureRejectsPaidReportAuthority") is True,
    "desktop-surface-readonly": desktop_surface.get("coverage", {}).get("projectionOnlyMarked") is True
    and desktop_surface.get("coverage", {}).get("coreAuthorityFalseMarked") is True
    and desktop_surface.get("coverage", {}).get("writesAuthorityFalseMarked") is True
    and desktop_surface.get("coverage", {}).get("noCommercialAuthorityWrites") is True,
    "negative-fixtures-cover-required-cases": negative_fixtures.get("coverage", {}).get("allRequiredFixtureIdsPresent") is True
    and negative_fixtures.get("coverage", {}).get("allFixturesExecuted") is True,
    "payment-cloud-and-new-industry-excluded": all(term in release_readme for term in [
...
failed = [key for key, passed in checks.items() if not passed]
primary_proofs = sorted(required_proof_paths | {"runtime/v123-release-certification.json"})
payload = {
    "version": "agentflow-v123-release-certification.v1",
    "status": "passed" if not failed else "failed",
    "releaseVersion": release_version,
    "releaseTag": release_tag,
    "sourceCommit": source_commit,
    ...
    "payload": {
        "releaseScope": "v1.2.3",
        "primary": True,
        "issueRefs": [f"#{issue}" for issue in range(903, 913)],
        "proofPaths": primary_proofs,
        "certifiedBoundary": "release closeout proof hardening and commercial surface traceability",
    },
    "checkedAt": int(time.time()),
}
out_path.write_text(json.dumps(payload, ensure_ascii=False, indent=2) + "\n", encoding="utf-8")
if failed:
    raise SystemExit(f"v123 release certification failed: {failed}")
PY

  record_stage "$stage" "passed" "$(basename "$V123_RELEASE_CERTIFICATION_PATH")"
}

run_v124_live_closeout_distinction_gate() {
  local stage="release.v124-live-closeout-distinction"
  record_stage "$stage" "started" "$V124_LIVE_CLOSEOUT_DISTINCTION_PATH"

  python3 - "$LIVE_GITHUB_MILESTONE_CLOSEOUT_PATH" "$V124_LIVE_CLOSEOUT_DISTINCTION_PATH" <<'PY'
import json
import pathlib
import sys
import time
...
cases = [
    {
        "caseId": "closed-milestone-zero-open",
        "hasNoOpenIssues": True,
        "isMilestoneClosed": True,
        "closeoutState": "closed",
        "expectedFinalCloseout": True,
    },
    {
        "caseId": "open-milestone-zero-open",
        "hasNoOpenIssues": True,
        "isMilestoneClosed": False,
        "closeoutState": "open-no-open-issues",
        "expectedFinalCloseout": False,
    },
    {
        "caseId": "open-milestone-with-open-issues",
        "hasNoOpenIssues": False,
        "isMilestoneClosed": False,
        "closeoutState": "open-with-open-issues",
        "expectedFinalCloseout": False,
    },
]

for case in cases:
    actual = case["hasNoOpenIssues"] and case["isMilestoneClosed"]
    case["passed"] = actual == case["expectedFinalCloseout"]

coverage = {
    "separatesHasNoOpenIssues": all("hasNoOpenIssues" in case for case in cases),
    "separatesIsMilestoneClosed": all("isMilestoneClosed" in case for case in cases),
    "openNoOpenIssuesIsNotClosed": any(
        case["caseId"] == "open-milestone-zero-open"
        and case["hasNoOpenIssues"]
        and not case["isMilestoneClosed"]
        and not case["expectedFinalCloseout"]
        for case in cases
    ),
    "livePayloadUsesSplitFields": all(
        key in live
        for key in ["hasNoOpenIssues", "isMilestoneClosed", "closeoutState"]
    ) if live else True,
    "ambiguousTopLevelFieldRetired": "distinguishesNoOpenIssuesFromClosedMilestone" not in live,
}

payload = {
    "version": "agentflow-v124-live-closeout-distinction.v1",
    "status": "passed" if all(case["passed"] for case in cases) and all(coverage.values()) else "failed",
    "issueRefs": ["#923"],
    "sourceProofPath": str(live_path),
    "coverage": coverage,
    "cases": cases,
    "checkedAt": int(time.time()),
}
out_path.write_text(json.dumps(payload, ensure_ascii=False, indent=2) + "\n", encoding="utf-8")
if payload["status"] != "passed":
    raise SystemExit(f"v124 closeout distinction failed: {payload['coverage']}")
PY

  record_stage "$stage" "passed" "$(basename "$V124_LIVE_CLOSEOUT_DISTINCTION_PATH")"
}

run_v124_final_closeout_certification_gate() {
  local stage="release.v124-final-closeout-certification"
  record_stage "$stage" "started" "$V124_FINAL_CLOSEOUT_CERTIFICATION_PATH"

  python3 - \
    "$LIVE_GITHUB_MILESTONE_CLOSEOUT_PATH" \
    "$V124_LIVE_CLOSEOUT_DISTINCTION_PATH" \
    "$V124_FINAL_CLOSEOUT_CERTIFICATION_PATH" \
    "$REQUIRE_PUBLISHED_RELEASE_FACTS" \
    "$SOURCE_COMMIT_SHA" <<'PY'
import json
import pathlib
import sys
import time
...
live_path = pathlib.Path(sys.argv[1])
distinction_path = pathlib.Path(sys.argv[2])
out_path = pathlib.Path(sys.argv[3])
require_published = sys.argv[4] == "1"
source_commit = sys.argv[5]

live = json.loads(live_path.read_text(encoding="utf-8")) if live_path.is_file() else {}
distinction = json.loads(distinction_path.read_text(encoding="utf-8"))

def final_allowed(payload):
    return (
        payload.get("status") == "passed"
        and payload.get("hasNoOpenIssues") is True
        and payload.get("isMilestoneClosed") is True
        and payload.get("closeoutState") == "closed"
    )

waiver = live.get("decision", {}).get("waiver") or live.get("waiver")
waiver_contract = {
    "requiresReason": bool(waiver),
    "requiresObservedProviderState": bool(live.get("observedState")),
    "requiresTimestamp": bool(live.get("checkedAt") or live.get("observedAt")),
    "requiresSourceCommit": bool(source_commit),
}

deferred_rejected = not final_allowed({
    "status": "deferred",
    "hasNoOpenIssues": True,
    "isMilestoneClosed": False,
    "closeoutState": "open-no-open-issues",
})
live_final_allowed = final_allowed(live)
coverage = {
    "distinctionProofPassed": distinction.get("status") == "passed",
    "deferredLiveCloseoutRejectedWithoutWaiver": deferred_rejected,
    "publishedReleaseRequiresFinalCloseout": (not require_published) or live_final_allowed or bool(waiver),
    "waiverRequiresReasonObservedStateTimestampAndCommit": (
        not waiver
        or all(waiver_contract.values())
    ),
}
status = "passed" if all(coverage.values()) else "failed"
payload = {
    "version": "agentflow-v124-final-closeout-certification.v1",
    "status": status,
    "issueRefs": ["#924"],
    "requirePublishedReleaseFacts": require_published,
    "liveCloseoutStatus": live.get("status"),
    "liveFinalCloseoutAllowed": live_final_allowed,
    "waiver": waiver,
    "waiverContract": waiver_contract,
    "coverage": coverage,
    "checkedAt": int(time.time()),
}
out_path.write_text(json.dumps(payload, ensure_ascii=False, indent=2) + "\n", encoding="utf-8")
if status != "passed":
    raise SystemExit(f"v124 final closeout certification failed: {coverage}")
PY

  record_stage "$stage" "passed" "$(basename "$V124_FINAL_CLOSEOUT_CERTIFICATION_PATH")"
}

run_v124_commercial_runtime_proofs_gate() {
  local stage="release.v124-commercial-runtime-proofs"
  record_stage "$stage" "started" "$V124_COMMERCIAL_GOLDEN_PATH_PATH"

  run_workspace_cmd "$stage.cargo-test" "$RUNTIME_DIR/v124-commercial-runtime-cargo-test.txt" \
    cargo test -p agentflow-runtime-api commercial

  run_workspace_cmd "$stage.generate" "$RUNTIME_DIR/v124-commercial-runtime-proofs.txt" \
    cargo run -p agentflow-runtime-api --example v124_commercial_runtime_proofs -- \
      "$V124_COMMERCIAL_PRODUCT_READ_MODEL_RUNTIME_API_PATH" \
      "$V124_COMMERCIAL_PRODUCT_PROJECTION_QUERY_PATH" \
      "$V124_PAID_REPORT_PREFLIGHT_RUNTIME_API_PATH" \
      "$V124_MANAGED_PROJECT_COMMERCIAL_RUNTIME_FIXTURE_PATH" \
      "$V124_COMMERCIAL_NEGATIVE_RUNTIME_FIXTURES_PATH" \
      "$V124_COMMERCIAL_GOLDEN_PATH_PATH"
  ...
  python3 - \
    ...
    "$V124_MANAGED_PROJECT_COMMERCIAL_RUNTIME_FIXTURE_PATH" \
    "$V124_COMMERCIAL_NEGATIVE_RUNTIME_FIXTURES_PATH" \
    "$V124_COMMERCIAL_GOLDEN_PATH_PATH" <<'PY'
import json
import pathlib
import sys
...
if failed:
    raise SystemExit(f"v124 commercial runtime proofs failed: {failed}")
PY

  record_stage "$stage" "passed" "v124 commercial runtime proofs"
}

run_v124_release_certification_gate() {
  local stage="release.v124-release-certification"
  local gate_run_id_for_cert="${GATE_RUN_ID:-local-workflow-run}"

  record_stage "$stage" "started" "$V124_RELEASE_CERTIFICATION_PATH"
  ...
  python3 - \
    ...
    "$gate_run_id_for_cert" \
    "$SOURCE_COMMIT_SHA" \
    "$V124_RELEASE_CERTIFICATION_PATH" \
    "$V124_LIVE_CLOSEOUT_DISTINCTION_PATH" \
    "$V124_FINAL_CLOSEOUT_CERTIFICATION_PATH" \
    "$V124_COMMERCIAL_PRODUCT_READ_MODEL_RUNTIME_API_PATH" \
    "$V124_COMMERCIAL_PRODUCT_PROJECTION_QUERY_PATH" \
...
docs_readme = (root / "docs/README.md").read_text(encoding="utf-8")
delivery_readme = (root / "docs/delivery/README.md").read_text(encoding="utf-8")
release_readme = (root / "docs/delivery/releases/v1.2.4/README.md").read_text(encoding="utf-8")
release_tasks = (root / "docs/delivery/releases/v1.2.4/AGENTFLOW_V1_2_4_COMMERCIAL_RUNTIME_READ_MODEL_TASKS_V1.md").read_text(encoding="utf-8")
app = (root / "apps/desktop/src/App.tsx").read_text(encoding="utf-8")

def proof_passed(proof):
    return proof.get("status") == "passed" and proof.get("payload", {}).get("status") == "passed"

checks = {
    "release-version-is-v124": version_at_or_after(release_version, "v1.2.4") and version_at_or_after(release_tag, "v1.2.4"),
    "workspace-version-is-v124": version_at_or_after(cargo_version, "1.2.4"),
    "cargo-lock-agentflow-packages-are-v124": all(
        version_at_or_after(package.get("version"), "1.2.4")
        for package in cargo_lock.get("package", [])
        if str(package.get("name", "")).startswith("agentflow-")
    ),
    "desktop-package-version-is-v124": version_at_or_after(package_json.get("version"), "1.2.4"),
    ...
    "desktop-uses-runtime-read-model": "load_commercial_product_read_model" in app and "useCommercialProductReadModel" in app,
    "desktop-preview-fallback-marked": "data-agentflow-preview-fallback" in app and "buildBrowserPreviewCommercialBoundaryReadModel" in app,
    "commercial-read-model-runtime-api": proofs["v124-commercial-product-read-model-runtime-api.json"].get("payload", {}).get("writesAuthority") is False,
    "commercial-projection-query-readonly": proofs["v124-commercial-product-projection-query.json"].get("payload", {}).get("writesAuthority") is False,
    "paid-report-preflight-runtime-api": any(
        case.get("result", {}).get("decision") == "allowed"
        and case.get("result", {}).get("runtimeAdmissionRequired") is True
        and case.get("result", {}).get("canStartRunDirectly") is False
        for case in proofs["v124-paid-report-preflight-runtime-api.json"].get("cases", [])
    ),
    "managed-project-commercial-boundary": proof_passed(proofs["v124-managed-project-commercial-runtime-fixture.json"]),
    "commercial-negative-runtime-fixtures": proof_passed(proofs["v124-commercial-negative-runtime-fixtures.json"]),
    "commercial-golden-path": proof_passed(proofs["v124-commercial-golden-path.json"]),
}
failed = [key for key, passed in checks.items() if not passed]
primary_proofs = sorted(f"runtime/{path.name}" for path in proof_paths) + ["runtime/v124-release-certification.json"]
payload = {
    "version": "agentflow-v124-release-certification.v1",
    "status": "passed" if not failed else "failed",
    "releaseVersion": release_version,
    "releaseTag": release_tag,
    "sourceCommit": source_commit,
    ...
    "payload": {
        "releaseScope": "v1.2.4",
        "primary": True,
        "issueRefs": [f"#{issue}" for issue in range(923, 933)],
        "proofPaths": primary_proofs,
        "certifiedBoundary": "commercial runtime read model and closeout distinction",
    },
    "checkedAt": int(time.time()),
}
out_path.write_text(json.dumps(payload, ensure_ascii=False, indent=2) + "\n", encoding="utf-8")
if failed:
    raise SystemExit(f"v124 release certification failed: {failed}")
PY

  record_stage "$stage" "passed" "$(basename "$V124_RELEASE_CERTIFICATION_PATH")"
}

run_v125_release_publication_state_gate() {
  local stage="release.v125-release-publication-state"
  record_stage "$stage" "started" "$V125_RELEASE_PUBLICATION_STATE_PATH"

  python3 - \
    "$LIVE_GITHUB_MILESTONE_CLOSEOUT_PATH" \
    "$V125_RELEASE_PUBLICATION_STATE_PATH" \
    "$RELEASE_VERSION" \
    "$RELEASE_TAG_NAME" \
    "$RELEASE_URL" \
    "$GATE_RUN_ID" \
    "$SOURCE_COMMIT_SHA" \
    "$REQUIRE_PUBLISHED_RELEASE_FACTS" <<'PY'
import json
import pathlib
import sys
import time
...
live_path = pathlib.Path(sys.argv[1])
out_path = pathlib.Path(sys.argv[2])
release_version, release_tag, release_url, workflow_run_id, source_commit = sys.argv[3:8]
require_published = sys.argv[8] == "1"
live = json.loads(live_path.read_text(encoding="utf-8")) if live_path.is_file() else {}
...
states = [
    {
        ...
        "releaseEventWorkflowRunId": None,
    ...
    },
    {
        ...
        "remoteTagExists": True,
        "githubReleaseExists": True,
        "releaseEventWorkflowRunId": workflow_run_id or "local-workflow-run",
        "milestoneClosed": True,
        "certificationKind": "published",
        "canPublish": False,
    },
]
negative = {
    "stateId": "open-milestone-zero-open-issues",
    "hasNoOpenIssues": True,
    "isMilestoneClosed": False,
    "certificationKind": "published",
    "publishedCertificationAllowed": False,
}
published_ready = (
    live.get("status") == "passed"
    and live.get("isMilestoneClosed") is True
    and live.get("hasNoOpenIssues") is True
)
coverage = {
    "statesSeparated": all(
        all(key in state for key in ["candidateReady", "remoteTagExists", "githubReleaseExists", "milestoneClosed", "certificationKind"])
        for state in states
    ),
    "candidateDoesNotRequireRemoteRelease": states[0]["canPublish"] is True,
    "taggedIsNotPublished": states[1]["certificationKind"] == "candidate",
    "releasedWithoutReleaseEventIsNotPublished": states[2]["certificationKind"] == "candidate",
    "publishedRequiresClosedMilestoneAndReleaseEvent": states[3]["certificationKind"] == "published"
        and states[3]["milestoneClosed"] is True
        and bool(states[3]["releaseEventWorkflowRunId"]),
    "openMilestoneWithZeroOpenIssuesRejected": negative["publishedCertificationAllowed"] is False,
    "livePublishedFactsPresentWhenRequired": (not require_published) or published_ready,
}
payload = {
    "version": "agentflow-v125-release-publication-state.v1",
    "status": "passed" if all(coverage.values()) else "failed",
    "issueRefs": ["#934"],
    "releaseVersion": release_version,
    "releaseTag": release_tag,
...
out_path.write_text(json.dumps(payload, ensure_ascii=False, indent=2) + "\n", encoding="utf-8")
if payload["status"] != "passed":
    raise SystemExit(f"v125 release publication state failed: {coverage}")
PY

  record_stage "$stage" "passed" "$(basename "$V125_RELEASE_PUBLICATION_STATE_PATH")"
}

run_v125_candidate_published_certification_split_gate() {
  local stage="release.v125-certification-split"
  record_stage "$stage" "started" "$V125_CERTIFICATION_SPLIT_PATH"

  python3 - \
    "$V125_RELEASE_PUBLICATION_STATE_PATH" \
    "$V125_CERTIFICATION_SPLIT_PATH" \
    "$REQUIRE_PUBLISHED_RELEASE_FACTS" <<'PY'
import json
import pathlib
import sys
...
out_path = pathlib.Path(sys.argv[2])
require_published = sys.argv[3] == "1"
publication = json.loads(publication_path.read_text(encoding="utf-8"))
states = {state.get("stateId"): state for state in publication.get("states", [])}
candidate = states.get("candidate") or {}
published = states.get("published") or {}
coverage = {
    "candidateCertificationKindPresent": candidate.get("certificationKind") == "candidate",
    "publishedCertificationKindPresent": published.get("certificationKind") == "published",
    "candidateCannotSatisfyPublished": candidate.get("milestoneClosed") is False and candidate.get("githubReleaseExists") is False,
    "publishedRequiresReleaseEventAndClosedMilestone": bool(published.get("releaseEventWorkflowRunId")) and published.get("milestoneClosed") is True,
    "currentGateKindMatchesContext": (not require_published) or publication.get("coverage", {}).get("livePublishedFactsPresentWhenRequired") is True,
}
payload = {
    "version": "agentflow-v125-candidate-published-certification-split.v1",
    "status": "passed" if all(coverage.values()) else "failed",
    "issueRefs": ["#935"],
    "certificationKinds": ["candidate", "published"],
    "candidateCertification": candidate,
    "publishedCertification": published,
    "coverage": coverage,
    "checkedAt": int(time.time()),
}
out_path.write_text(json.dumps(payload, ensure_ascii=False, indent=2) + "\n", encoding="utf-8")
if payload["status"] != "passed":
    raise SystemExit(f"v125 certification split failed: {coverage}")
PY

  record_stage "$stage" "passed" "$(basename "$V125_CERTIFICATION_SPLIT_PATH")"
}

run_v125_waiver_contract_consistency_gate() {
  local stage="release.v125-waiver-contract-consistency"
  record_stage "$stage" "started" "$V125_WAIVER_CONTRACT_CONSISTENCY_PATH"

  python3 - "$V125_WAIVER_CONTRACT_CONSISTENCY_PATH" "$SOURCE_COMMIT_SHA" <<'PY'
import json
import pathlib
import sys
import time
...
def valid_waiver(waiver):
    if waiver is None:
        return True
    return all(bool(waiver.get(key)) for key in ["reason", "observedProviderState", "timestamp", "sourceCommit"])

cases = [
    {"caseId": "absent-waiver", "waiver": None, "expectedValid": True},
    {
        "caseId": "complete-waiver",
        "waiver": {
            "reason": "provider temporarily unavailable after source certification",
            "observedProviderState": "release-event-pending",
            "timestamp": int(time.time()),
            "sourceCommit": source_commit,
        },
        "expectedValid": True,
    ...
    {
        "caseId": "missing-observed-provider-state",
        "waiver": {
...
for case in cases:
    case["actualValid"] = valid_waiver(case.get("waiver"))
    case["passed"] = case["actualValid"] == case["expectedValid"]
coverage = {
    "absentWaiverAllowed": cases[0]["passed"],
    "completeWaiverAllowed": cases[1]["passed"],
    "missingReasonRejected": cases[2]["passed"],
    "missingObservedProviderStateRejected": cases[3]["passed"],
    "missingTimestampRejected": cases[4]["passed"],
    "missingSourceCommitRejected": cases[5]["passed"],
}
payload = {
    "version": "agentflow-v125-waiver-contract-consistency.v1",
    "status": "passed" if all(coverage.values()) else "failed",
    "issueRefs": ["#936"],
    "requiredFieldsWhenWaiverExists": ["reason", "observedProviderState", "timestamp", "sourceCommit"],
    "cases": cases,
    "coverage": coverage,
    "checkedAt": int(time.time()),
}
out_path.write_text(json.dumps(payload, ensure_ascii=False, indent=2) + "\n", encoding="utf-8")
if payload["status"] != "passed":
    raise SystemExit(f"v125 waiver contract consistency failed: {coverage}")
PY

  record_stage "$stage" "passed" "$(basename "$V125_WAIVER_CONTRACT_CONSISTENCY_PATH")"
}

run_v125_commercial_registry_runtime_proofs_gate() {
  local stage="release.v125-commercial-registry-runtime-proofs"
  record_stage "$stage" "started" "$V125_COMMERCIAL_GOLDEN_PATH_REGISTRY_PATH"

  run_workspace_cmd "$stage.cargo-test" "$RUNTIME_DIR/v125-commercial-runtime-cargo-test.txt" \
    cargo test -p agentflow-runtime-api commercial

  run_workspace_cmd "$stage.generate" "$RUNTIME_DIR/v125-commercial-runtime-proofs.txt" \
    cargo run -p agentflow-runtime-api --example v125_commercial_runtime_proofs -- \
      "$V125_PRODUCT_REGISTRY_READ_MODEL_PATH" \
      "$V125_ENTITLEMENT_SOURCE_FIXTURE_PATH" \
      "$V125_PAID_REPORT_PRODUCT_DEFINITION_PATH" \
      "$V125_DESKTOP_RUNTIME_ONLY_COMMERCIAL_SURFACE_PATH" \
      "$V125_COMMERCIAL_GOLDEN_PATH_REGISTRY_PATH"
  ...
  python3 - \
    ...
    "$V125_PAID_REPORT_PRODUCT_DEFINITION_PATH" \
    "$V125_DESKTOP_RUNTIME_ONLY_COMMERCIAL_SURFACE_PATH" \
    "$V125_COMMERCIAL_GOLDEN_PATH_REGISTRY_PATH" <<'PY'
import json
import pathlib
import sys
...
for path in paths:
    ...
    if payload.get("status") != "passed":
        failed.append(path.name)
app = (root / "apps/desktop/src/App.tsx").read_text(encoding="utf-8")
if "data-agentflow-preview-fallback" not in app or "buildBrowserPreviewCommercialBoundaryReadModel" not in app:
    failed.append("desktop-preview-fallback-marker")
if "load_commercial_product_read_model" not in app:
    failed.append("desktop-runtime-read-model-command")
if failed:
    raise SystemExit(f"v125 commercial registry runtime proofs failed: {failed}")
PY

  record_stage "$stage" "passed" "v125 commercial registry runtime proofs"
}

run_v125_release_event_artifact_certification_gate() {
  local stage="release.v125-release-event-artifact-certification"
  record_stage "$stage" "started" "$V125_RELEASE_EVENT_ARTIFACT_CERTIFICATION_PATH"

  python3 - \
    "$V125_RELEASE_PUBLICATION_STATE_PATH" \
    "$V125_RELEASE_EVENT_ARTIFACT_CERTIFICATION_PATH" \
    "$RELEASE_VERSION" \
    "$RELEASE_TAG_NAME" \
    "$RELEASE_URL" \
    "$GATE_RUN_ID" \
...
release_version, release_tag, release_url, workflow_run_id, source_commit = sys.argv[3:8]
require_published = sys.argv[8] == "1"
proof_paths = [pathlib.Path(value) for value in sys.argv[9:]]
publication = json.loads(publication_path.read_text(encoding="utf-8"))
proofs = {path.name: json.loads(path.read_text(encoding="utf-8")) for path in proof_paths}
artifact_manifest = {
    "releaseTag": release_tag,
    "releaseUrl": release_url,
    "sourceCommit": source_commit,
    "workflowRunId": workflow_run_id or "local-workflow-run",
    "proofs": [f"runtime/{path.name}" for path in proof_paths],
}
negative_fixtures = [
    {"caseId": "wrong-tag", "passed": release_tag == release_version},
    {"caseId": "missing-release", "passed": (not require_published) or bool(release_url)},
    {
        "caseId": "open-milestone",
        "passed": (not require_published)
        or publication.get("coverage", {}).get("livePublishedFactsPresentWhenRequired") is True,
    },
]
coverage = {
    "tagMatchesReleaseVersion": release_tag == release_version,
    "releaseUrlPresent": bool(release_url),
    "workflowRunRecorded": bool(artifact_manifest["workflowRunId"]),
    "sourceCommitRecorded": bool(source_commit),
    "artifactManifestPresent": len(artifact_manifest["proofs"]) == len(proof_paths),
    "primaryProofsPassed": all(proof.get("status") == "passed" for proof in proofs.values()),
    "publishedFactsPresentWhenRequired": (not require_published)
        or publication.get("coverage", {}).get("livePublishedFactsPresentWhenRequired") is True,
    "negativeFixturesPresent": all("caseId" in item for item in negative_fixtures),
}
payload = {
    "version": "agentflow-v125-release-event-artifact-certification.v1",
    "status": "passed" if all(coverage.values()) else "failed",
    "issueRefs": ["#942"],
    "certificationKind": "published" if require_published else "candidate",
    "releaseVersion": release_version,
...
out_path.write_text(json.dumps(payload, ensure_ascii=False, indent=2) + "\n", encoding="utf-8")
if payload["status"] != "passed":
    raise SystemExit(f"v125 release-event artifact certification failed: {coverage}")
PY

  record_stage "$stage" "passed" "$(basename "$V125_RELEASE_EVENT_ARTIFACT_CERTIFICATION_PATH")"
}

run_v125_release_certification_gate() {
  local stage="release.v125-release-certification"
  local gate_run_id_for_cert="${GATE_RUN_ID:-local-workflow-run}"
  record_stage "$stage" "started" "$V125_RELEASE_CERTIFICATION_PATH"
  ...
  python3 - \
    ...
    "$gate_run_id_for_cert" \
    "$SOURCE_COMMIT_SHA" \
    "$V125_RELEASE_CERTIFICATION_PATH" \
    "$V125_RELEASE_PUBLICATION_STATE_PATH" \
    "$V125_CERTIFICATION_SPLIT_PATH" \
    "$V125_WAIVER_CONTRACT_CONSISTENCY_PATH" \
    "$V125_PRODUCT_REGISTRY_READ_MODEL_PATH" \
    "$V125_ENTITLEMENT_SOURCE_FIXTURE_PATH" \
    "$V125_PAID_REPORT_PRODUCT_DEFINITION_PATH" \
    "$V125_DESKTOP_RUNTIME_ONLY_COMMERCIAL_SURFACE_PATH" \
    "$V125_COMMERCIAL_GOLDEN_PATH_REGISTRY_PATH" \
    "$V125_RELEASE_EVENT_ARTIFACT_CERTIFICATION_PATH" <<'PY'
import json
import pathlib
import sys
import time
...
checks = {
    ...
    "registry-backed-read-model": proofs["v125-product-registry-commercial-read-model.json"].get("source") == "product-registry-config",
    "entitlement-source-fixture": proofs["v125-entitlement-source-fixture.json"].get("status") == "passed",
    "paid-report-definition-fixture": proofs["v125-paid-report-product-definition.json"].get("status") == "passed",
    "desktop-runtime-only-surface": "data-agentflow-preview-fallback" in app and "load_commercial_product_read_model" in app,
    "commercial-golden-path-registry": proofs["v125-commercial-golden-path-registry.json"].get("status") == "passed",
    "release-event-artifact-certification": proofs["v125-release-event-artifact-certification.json"].get("status") == "passed",
}
failed = [key for key, passed in checks.items() if not passed]
primary_proofs = sorted(f"runtime/{path.name}" for path in proof_paths) + ["runtime/v125-release-certification.json"]
payload = {
    ...
    "payload": {
        "releaseScope": "v1.2.5",
        "primary": True,
        "issueRefs": [f"#{issue}" for issue in range(934, 944)],
        "proofPaths": primary_proofs,
        "certifiedBoundary": "published release certification and registry-backed commercial runtime",
    },
    "checkedAt": int(time.time()),
}
out_path.write_text(json.dumps(payload, ensure_ascii=False, indent=2) + "\n", encoding="utf-8")
if failed:
    raise SystemExit(f"v125 release certification failed: {failed}")
PY
...
checks = {
    "release-version-at-or-after-v126": version_at_or_after(release_version, "v1.2.6") and version_at_or_after(release_tag, "v1.2.6"),
    "workspace-version-at-or-after-v126": version_at_or_after(f"v{cargo_version}", "v1.2.6"),
    "cargo-lock-agentflow-packages-are-v126": all(
        version_at_or_after(f"v{package.get('version')}", "v1.2.6")
        for package in cargo_lock.get("package", [])
        if str(package.get("name", "")).startswith("agentflow-")
    ),
    "desktop-package-version-at-or-after-v126": version_at_or_after(f"v{package_json.get('version')}", "v1.2.6"),
    "desktop-lock-version-at-or-after-v126": version_at_or_after(f"v{package_lock.get('version')}", "v1.2.6")
...
run_v127_paid_report_handoff_closure_gate() {
  local stage="release.v127-paid-report-handoff-closure"
  record_stage "$stage" "started" "$V127_PAID_REPORT_DELIVERY_PROJECTION_CONTRACT_PATH"

  run_workspace_cmd "$stage.cargo-test" "$RUNTIME_DIR/v127-commercial-runtime-cargo-test.txt" \
    cargo test -p agentflow-runtime-api commercial

  run_workspace_cmd "$stage.generate" "$RUNTIME_DIR/v127-commercial-runtime-proofs.txt" \
    cargo run -p agentflow-runtime-api --example v127_commercial_runtime_proofs -- \
      "$V127_NEXT_RELEASE_PLANNING_ALIGNMENT_PATH" \
      "$V127_PRODUCT_FLOW_SOURCE_BOUNDARY_PATH" \
      "$V127_PROJECT_PAID_REPORT_INSTANCE_RESOLVER_PATH" \
      "$V127_PROJECT_PAID_REPORT_PREFLIGHT_HANDOFF_API_PATH" \
      "$V127_DESKTOP_PAID_REPORT_PROJECT_ROOT_BRIDGE_PATH" \
      "$V127_GOLDEN_PATH_SOURCE_SEMANTICS_PATH" \
      "$V127_RUNTIME_PROPOSAL_ADMISSION_RECEIPT_PATH" \
      "$V127_PAID_REPORT_RUN_CONTRACT_BOUNDARY_PATH" \
      "$V127_PAID_REPORT_DELIVERY_PROJECTION_CONTRACT_PATH"
  ...
  python3 - \
    ...
    "$V127_RUNTIME_PROPOSAL_ADMISSION_RECEIPT_PATH" \
    "$V127_PAID_REPORT_RUN_CONTRACT_BOUNDARY_PATH" \
    "$V127_PAID_REPORT_DELIVERY_PROJECTION_CONTRACT_PATH" <<'PY'
import json
import pathlib
import sys
...
proofs = {path.name: json.loads(path.read_text(encoding="utf-8")) for path in paths}
failed = [name for name, proof in proofs.items() if proof.get("status") != "passed"]
runtime_api = (root / "crates/runtime-api/src/commercial.rs").read_text(encoding="utf-8")
tauri = (root / "apps/desktop/src-tauri/src/commands/runtime_api.rs").read_text(encoding="utf-8")
main_rs = (root / "apps/desktop/src-tauri/src/main.rs").read_text(encoding="utf-8")
if "resolve_paid_report_product_instance_from_project" not in runtime_api:
    failed.append("missing-project-instance-resolver")
if "build_paid_report_runtime_proposal_handoff_from_project" not in runtime_api:
    failed.append("missing-project-handoff-builder")
if "PaidReportRuntimeAdmissionReceipt" not in runtime_api:
    failed.append("missing-admission-receipt")
if "PaidReportRunContract" not in runtime_api:
    failed.append("missing-run-contract")
if "PaidReportDeliveryProjection" not in runtime_api:
    failed.append("missing-delivery-projection")
if "build_paid_report_runtime_proposal_handoff_from_project" not in tauri:
    failed.append("tauri-does-not-use-project-handoff")
if "_project_root: String" in tauri:
    failed.append("tauri-ignores-project-root")
if "build_paid_report_runtime_handoff" not in main_rs:
    failed.append("tauri-handoff-command-not-registered")
source_boundary = proofs["v127-product-flow-source-boundary.json"].get("sourceScan", {})
if source_boundary.get("forbiddenTermHits"):
    failed.append("core-runtime-has-concrete-sku-term")
handoff = proofs["v127-project-paid-report-preflight-handoff-api.json"].get("payload", {})
proposal = handoff.get("proposal") or {}
if proposal.get("canStartRunDirectly") is not False:
    failed.append("handoff-allows-direct-run")
admission = proofs["v127-runtime-proposal-admission-receipt.json"].get("payload", {})
if admission.get("status") != "admitted" or admission.get("canStartRunDirectly") is not False:
    failed.append("admission-receipt-not-authoritative")
run_contract = proofs["v127-paid-report-run-contract-boundary.json"].get("payload", {})
if run_contract.get("concreteSkuIsCoreAuthority") is not False:
    failed.append("run-contract-allows-concrete-sku-authority")
delivery = proofs["v127-paid-report-evidence-decision-delivery-projection-contract.json"].get("states", {}).get("deliveryReady", {})
if delivery.get("writesAuthority") is not False or delivery.get("deliveryReady") is not True:
    failed.append("delivery-projection-authority-or-ready-mismatch")
if failed:
    raise SystemExit(f"v127 paid report handoff closure proofs failed: {failed}")
PY

  record_stage "$stage" "passed" "v127 paid report handoff closure proofs"
}

run_v127_release_certification_gate() {
  local stage="release.v127-release-certification"
  local gate_run_id_for_cert="${GATE_RUN_ID:-local-workflow-run}"
  record_stage "$stage" "started" "$V127_RELEASE_CERTIFICATION_PATH"
  ...
  python3 - \
    ...
    "$SOURCE_COMMIT_SHA" \
    "$REQUIRE_PUBLISHED_RELEASE_FACTS" \
    "$V127_RELEASE_CERTIFICATION_PATH" \
    "$V127_NEXT_RELEASE_PLANNING_ALIGNMENT_PATH" \
    "$V127_PRODUCT_FLOW_SOURCE_BOUNDARY_PATH" \
    "$V127_PROJECT_PAID_REPORT_INSTANCE_RESOLVER_PATH" \
    "$V127_PROJECT_PAID_REPORT_PREFLIGHT_HANDOFF_API_PATH" \
...
certification_kind = "published" if require_published else "candidate"
allowed_versions = {"v1.2.7", "v1.2.8", "v1.2.9"}
allowed_package_versions = {"1.2.7", "1.2.8", "1.2.9"}
checks = {
    ...
    "cargo-lock-agentflow-packages-at-or-after-v127": all(
        package.get("version") in allowed_package_versions
        for package in cargo_lock.get("package", [])
        if str(package.get("name", "")).startswith("agentflow-")
    ),
    "desktop-package-version-at-or-after-v127": package_json.get("version") in allowed_package_versions,
    "desktop-lock-version-at-or-after-v127": package_lock.get("version") in allowed_package_versions
    ...
    "project-instance-proof": proofs["v127-project-paid-report-instance-resolver.json"].get("coverage", {}).get("projectRootUsed") is True,
    "handoff-proof": proofs["v127-project-paid-report-preflight-handoff-api.json"].get("coverage", {}).get("preflightCreatesRuntimeProposalOnly") is True,
    "desktop-bridge-proof": proofs["v127-desktop-paid-report-project-root-bridge.json"].get("desktopSurface", {}).get("tauriCommandUsesProjectRoot") is True,
    "golden-source-proof": proofs["v127-golden-path-source-semantics.json"].get("sourceSemantics", {}).get("concreteSkuNamesAreNotCoreAuthority") is True,
    "admission-proof": proofs["v127-runtime-proposal-admission-receipt.json"].get("coverage", {}).get("directRunRejected") is True,
    "run-contract-proof": proofs["v127-paid-report-run-contract-boundary.json"].get("coverage", {}).get("genericPaidReportFlowOnly") is True,
    "delivery-projection-proof": proofs["v127-paid-report-evidence-decision-delivery-projection-contract.json"].get("coverage", {}).get("deliveryRequiresEvidenceAndDecision") is True,
}
failed = [key for key, passed in checks.items() if not passed]
primary_proofs = sorted(f"runtime/{path.name}" for path in proof_paths) + ["runtime/v127-release-certification.json"]
payload = {
    "version": "agentflow-v127-release-certification.v1",
    "status": "passed" if not failed else "failed",
    "certificationKind": certification_kind,
    "releaseVersion": release_version,
    "releaseTag": release_tag,
    ...
    "payload": {
        "releaseScope": "v1.2.7",
        "primary": True,
        "issueRefs": [f"#{issue}" for issue in range(956, 966)],
        "proofPaths": primary_proofs,
        "certifiedBoundary": "project-scoped paid report runtime handoff closure",
        "publicCommercialLaunch": False,
        "realPaidReportGeneration": False,
        "paymentProviderIntegration": False,
    },
    "checkedAt": int(time.time()),
}
out_path.write_text(json.dumps(payload, ensure_ascii=False, indent=2) + "\n", encoding="utf-8")
if failed:
    raise SystemExit(f"v127 release certification failed: {failed}")
PY

  record_stage "$stage" "passed" "$(basename "$V127_RELEASE_CERTIFICATION_PATH")"
}

run_v128_paid_report_run_delivery_artifact_closure_gate() {
  local stage="release.v128-paid-report-run-delivery-artifact-closure"
  record_stage "$stage" "started" "$V128_FEEDBACK_REPAIR_REQUEST_LOOP_PATH"

  run_workspace_cmd "$stage.cargo-test" "$RUNTIME_DIR/v128-commercial-runtime-cargo-test.txt" \
    cargo test -p agentflow-runtime-api commercial

  run_workspace_cmd "$stage.generate" "$RUNTIME_DIR/v128-commercial-runtime-proofs.txt" \
    cargo run -p agentflow-runtime-api --example v128_commercial_runtime_proofs -- \
      "$V128_RELEASE_PROVENANCE_TAG_POLICY_REPAIR_PATH" \
      "$V128_PROJECT_UNIQUE_PRODUCT_INSTANCE_IDENTITY_PATH" \
      "$V128_PAID_REPORT_INPUT_SNAPSHOT_ORDER_INTENT_PATH" \
      "$V128_PAID_REPORT_RUN_EXECUTION_RECEIPT_PATH" \
      "$V128_REPORT_ARTIFACT_SCHEMA_STORAGE_BOUNDARY_PATH" \
      "$V128_REPORT_GENERATION_EVIDENCE_CAPTURE_PATH" \
      "$V128_DECISION_GATE_REPORT_DELIVERY_PATH" \
      "$V128_DELIVERY_PACKAGE_PROJECTION_DOWNLOAD_CONTRACT_PATH" \
      "$V128_FEEDBACK_REPAIR_REQUEST_LOOP_PATH"
  ...
  python3 - \
    ...
    "$V128_DECISION_GATE_REPORT_DELIVERY_PATH" \
    "$V128_DELIVERY_PACKAGE_PROJECTION_DOWNLOAD_CONTRACT_PATH" \
    "$V128_FEEDBACK_REPAIR_REQUEST_LOOP_PATH" <<'PY'
import json
import pathlib
import sys
...
for symbol in required_symbols:
    if symbol not in runtime_api:
        failed.append(f"missing-{symbol}")
project_identity = proofs["v128-project-unique-product-instance-identity.json"].get("coverage", {})
if project_identity.get("projectUnique") is not True or project_identity.get("sourceLevelRejected") is not True:
    failed.append("project-unique-identity-not-proven")
input_snapshot = proofs["v128-paid-report-input-snapshot-order-intent-contract.json"]
if input_snapshot.get("orderIntent", {}).get("paymentProviderCharge") is not False:
    failed.append("order-intent-looks-like-payment-charge")
run_receipt = proofs["v128-paid-report-run-execution-receipt.json"]
if run_receipt.get("successful", {}).get("status") != "completed" or run_receipt.get("blocked", {}).get("status") != "blocked":
    failed.append("run-receipt-success-blocked-cases-missing")
artifact = proofs["v128-report-artifact-schema-storage-boundary.json"]
if artifact.get("completeArtifact", {}).get("deliveryReady") is not True:
    failed.append("complete-artifact-not-delivery-ready")
if artifact.get("incompleteArtifact", {}).get("deliveryReady") is not False:
    failed.append("incomplete-artifact-delivery-ready")
evidence = proofs["v128-report-generation-evidence-capture.json"]
if evidence.get("completeEvidence", {}).get("evidenceComplete") is not True:
    failed.append("complete-evidence-not-complete")
if evidence.get("missingEvidence", {}).get("status") != "evidence-needed":
    failed.append("missing-evidence-status-not-evidence-needed")
decision = proofs["v128-decision-gate-report-delivery.json"]
if decision.get("accepted", {}).get("outcome") != "accepted":
    failed.append("accepted-decision-missing")
if decision.get("needsFix", {}).get("failureReasons") in (None, []):
    failed.append("non-accepted-decision-missing-reasons")
delivery = proofs["v128-delivery-package-projection-download-contract.json"]
if delivery.get("deliveryReady", {}).get("downloadReady") is not True:
    failed.append("delivery-package-not-download-ready")
if delivery.get("blockedOrNeedsFix", {}).get("downloadReady") is not False:
    failed.append("blocked-delivery-package-download-ready")
feedback = proofs["v128-feedback-repair-request-loop.json"]
if feedback.get("repairRequested", {}).get("mutatesDeliveredArtifact") is not False:
    failed.append("feedback-mutates-delivered-artifact")
source_boundary = feedback.get("sourceBoundary", {})
if source_boundary.get("forbiddenTermHits"):
    failed.append("core-runtime-has-concrete-report-sku-term")
if failed:
    raise SystemExit(f"v128 paid report run delivery artifact closure proofs failed: {failed}")
PY

  record_stage "$stage" "passed" "v128 paid report run delivery artifact closure proofs"
}

run_v128_release_certification_gate() {
  local stage="release.v128-release-certification"
  local gate_run_id_for_cert="${GATE_RUN_ID:-local-workflow-run}"
  record_stage "$stage" "started" "$V128_RELEASE_CERTIFICATION_PATH"
  ...
  python3 - \
    ...
    "$SOURCE_COMMIT_SHA" \
    "$REQUIRE_PUBLISHED_RELEASE_FACTS" \
    "$V128_RELEASE_CERTIFICATION_PATH" \
    "$RUNTIME_DIR/release-provenance.json" \
    "$RUNTIME_DIR/release-facts.json" \
    "$RUNTIME_DIR/release-tag-proof.json" \
    "$RUNTIME_DIR/remote-release-proof.json" \
    "$V128_RELEASE_PROVENANCE_TAG_POLICY_REPAIR_PATH" \
    "$V128_PROJECT_UNIQUE_PRODUCT_INSTANCE_IDENTITY_PATH" \
    "$V128_PAID_REPORT_INPUT_SNAPSHOT_ORDER_INTENT_PATH" \
    "$V128_PAID_REPORT_RUN_EXECUTION_RECEIPT_PATH" \
...
(
    ...
    require_published_raw,
    out_raw,
    release_provenance_raw,
    release_facts_raw,
    release_tag_proof_raw,
    remote_release_proof_raw,
    *proof_raws,
) = sys.argv[1:]
...
docs_readme = (root / "docs/README.md").read_text(encoding="utf-8")
delivery_readme = (root / "docs/delivery/README.md").read_text(encoding="utf-8")
release_readme = (root / "docs/delivery/releases/v1.2.8/README.md").read_text(encoding="utf-8")
release_tasks = (root / "docs/delivery/releases/v1.2.8/AGENTFLOW_V1_2_8_PAID_REPORT_RUN_DELIVERY_ARTIFACT_CLOSURE_TASKS_V1.md").read_text(encoding="utf-8")
runtime_api = (root / "crates/runtime-api/src/commercial.rs").read_text(encoding="utf-8")

def load_optional(path_raw):
    path = pathlib.Path(path_raw)
    if not path.is_file():
        return {}
    return json.loads(path.read_text(encoding="utf-8"))

release_provenance = load_optional(release_provenance_raw)
release_facts = load_optional(release_facts_raw)
...
checks = {
    "release-version-is-v128": version_at_or_after(release_version, "v1.2.8")
    and version_at_or_after(release_tag, "v1.2.8"),
    "workspace-version-is-v128": version_at_or_after(cargo_version, "1.2.8"),
    "cargo-lock-agentflow-packages-are-v128": all(
        version_at_or_after(package.get("version"), "1.2.8")
        for package in cargo_lock.get("package", [])
        if str(package.get("name", "")).startswith("agentflow-")
    ),
    "desktop-package-version-is-v128": version_at_or_after(package_json.get("version"), "1.2.8"),
    "desktop-lock-version-is-v128": version_at_or_after(package_lock.get("version"), "1.2.8")
    ...
    "release-provenance-proof": proofs["v128-release-provenance-tag-policy-repair.json"].get("tagPolicy", {}).get("staleFixtureCommitRejected") is True,
    "project-unique-proof": proofs["v128-project-unique-product-instance-identity.json"].get("coverage", {}).get("projectUnique") is True,
    "input-snapshot-proof": proofs["v128-paid-report-input-snapshot-order-intent-contract.json"].get("coverage", {}).get("orderIntentIsNotPaymentCharge") is True,
    "run-receipt-proof": proofs["v128-paid-report-run-execution-receipt.json"].get("coverage", {}).get("recordsSuccessAndBlockedCases") is True,
    "artifact-proof": proofs["v128-report-artifact-schema-storage-boundary.json"].get("coverage", {}).get("incompleteArtifactNotDeliveryReady") is True,
    "evidence-proof": proofs["v128-report-generation-evidence-capture.json"].get("coverage", {}).get("missingEvidenceKeepsDeliveryEvidenceNeeded") is True,
    "decision-proof": proofs["v128-decision-gate-report-delivery.json"].get("coverage", {}).get("acceptedRequiresCompleteEvidenceAndArtifact") is True,
    "delivery-package-proof": proofs["v128-delivery-package-projection-download-contract.json"].get("coverage", {}).get("downloadReadyOnlyAfterAcceptedDecision") is True,
    "feedback-proof": proofs["v128-feedback-repair-request-loop.json"].get("coverage", {}).get("feedbackDoesNotMutateDeliveredArtifact") is True,
    "core-pollution-scan": not forbidden_hits,
    "published-release-facts-match-source-commit": published_commit_checks,
}
failed = [key for key, passed in checks.items() if not passed]
primary_proofs = sorted(f"runtime/{path.name}" for path in proof_paths) + ["runtime/v128-release-certification.json"]
payload = {
    "version": "agentflow-v128-release-certification.v1",
    "status": "passed" if not failed else "failed",
    "certificationKind": certification_kind,
    "releaseVersion": release_version,
    "releaseTag": release_tag,
    ...
    "payload": {
        "releaseScope": "v1.2.8",
        "primary": True,
        "issueRefs": [f"#{issue}" for issue in range(967, 977)],
        "proofPaths": primary_proofs,
        "certifiedBoundary": "paid report run delivery artifact closure",
        "publicCommercialLaunch": False,
        "realPaidReportGeneration": False,
        "paymentProviderIntegration": False,
...
out_path.write_text(json.dumps(payload, ensure_ascii=False, indent=2) + "\n", encoding="utf-8")
if failed:
    raise SystemExit(f"v128 release certification failed: {failed}")
PY

  record_stage "$stage" "passed" "$(basename "$V128_RELEASE_CERTIFICATION_PATH")"
}

run_v129_commercial_order_access_closure_gate() {
  local stage="release.v129-commercial-order-access-closure"
  record_stage "$stage" "started" "$V129_COMMERCIAL_NEGATIVE_FIXTURES_PATH"

  run_workspace_cmd "$stage.cargo-test" "$RUNTIME_DIR/v129-commercial-runtime-cargo-test.txt" \
    cargo test -p agentflow-runtime-api commercial

  run_workspace_cmd "$stage.generate" "$RUNTIME_DIR/v129-commercial-runtime-proofs.txt" \
    cargo run -p agentflow-runtime-api --example v129_commercial_runtime_proofs -- \
      "$V129_RELEASE_PROVENANCE_FACTS_ALIGNMENT_PATH" \
      "$V129_ANNOTATED_TAG_KIND_CERTIFICATION_PATH" \
      "$V129_PAID_REPORT_ORDER_RECORD_PATH" \
      "$V129_PAYMENT_ENTITLEMENT_AUTHORIZATION_PATH" \
      "$V129_ORDER_TO_RUN_ADMISSION_PATH" \
      "$V129_CUSTOMER_DELIVERY_ACCESS_PATH" \
      "$V129_REPORT_DOWNLOAD_TOKEN_ACCESS_RECEIPT_PATH" \
      "$V129_REFUND_REPAIR_RERUN_POLICY_PATH" \
      "$V129_COMMERCIAL_NEGATIVE_FIXTURES_PATH" \
      "$V129_RELEASE_CERTIFICATION_INPUT_PATH"
...
alignment = proofs["v129-release-provenance-facts-commit-alignment.json"]
if alignment.get("syntheticProjectReleaseGateE2eCannotSatisfyPublishedReleaseCertification") is not True:
    failed.append("synthetic-release-facts-not-rejected")
tag_kind = proofs["v129-annotated-tag-kind-certification-repair.json"].get("tagPolicy", {})
if tag_kind.get("tagKindUnknownRejectedWhenReleaseProvenanceIsConcrete") is not True:
    failed.append("tag-kind-unknown-not-rejected")
order = proofs["v129-paid-report-order-record-contract.json"]
if order.get("orderRecord", {}).get("runnable") is not True:
    failed.append("order-record-not-runnable")
if order.get("missingInputOrder", {}).get("runnable") is not False:
    failed.append("missing-input-order-runnable")
authorization = proofs["v129-payment-entitlement-authorization-boundary.json"]
if authorization.get("paid", {}).get("status") != "authorized":
    failed.append("paid-authorization-not-authorized")
if authorization.get("refunded", {}).get("status") != "blocked":
    failed.append("refunded-authorization-not-blocked")
if authorization.get("paid", {}).get("paymentProviderCheckout") is not False:
    failed.append("provider-checkout-leaked-into-core")
admission = proofs["v129-order-to-run-admission-gate.json"]
if admission.get("acceptedAdmission", {}).get("accepted") is not True:
    failed.append("accepted-order-admission-missing")
if admission.get("blockedAdmission", {}).get("accepted") is not False:
    failed.append("blocked-order-admission-accepted")
access = proofs["v129-customer-delivery-access-projection.json"]
if access.get("allowedAccess", {}).get("downloadVisible") is not True:
    failed.append("allowed-access-not-visible")
if access.get("refundedAccess", {}).get("downloadVisible") is not False:
    failed.append("refunded-access-visible")
receipt = proofs["v129-report-download-token-access-receipt.json"]
if receipt.get("allowed", {}).get("status") != "allowed":
    failed.append("allowed-access-receipt-missing")
if receipt.get("expired", {}).get("blockedReason") != "access-expired":
    failed.append("expired-access-not-blocked")
if receipt.get("revoked", {}).get("blockedReason") != "access-revoked":
    failed.append("revoked-access-not-blocked")
policy = proofs["v129-refund-repair-rerun-policy-contract.json"]
if policy.get("repair", {}).get("mutatesDeliveredArtifact") is not False:
    failed.append("repair-mutates-delivered-artifact")
if policy.get("refund", {}).get("commercialDecisionOnly") is not True:
    failed.append("refund-not-commercial-policy-state")
if policy.get("rerun", {}).get("requiresNewAuthorization") is not True:
    failed.append("rerun-missing-new-authorization-rule")
negative = proofs["v129-commercial-negative-fixtures.json"]
fixtures = negative.get("fixtures", [])
required_fixture_ids = {
    "stale-release-facts-commit",
    "unknown-tag-kind",
    "fake-paid-entitlement",
    "refunded-order",
    "mismatched-product-instance-id",
    "missing-input-snapshot",
    "missing-accepted-decision",
    "expired-access-token",
}
fixture_ids = {fixture.get("id") for fixture in fixtures}
if not required_fixture_ids.issubset(fixture_ids):
    failed.append("missing-commercial-negative-fixtures")
if any(not fixture.get("reasonCode") for fixture in fixtures):
    failed.append("negative-fixture-missing-reason-code")
cert_input = proofs["v129-release-certification-input.json"]
if cert_input.get("publicCommercialLaunch") is not False:
    failed.append("public-commercial-launch-enabled")
if cert_input.get("concretePaidReportSku") is not False:
    failed.append("concrete-paid-report-sku-enabled")
if cert_input.get("paymentProviderCheckout") is not False:
    failed.append("payment-provider-checkout-enabled")

if failed:
    raise SystemExit(f"v129 commercial order/access closure proofs failed: {failed}")
PY

  record_stage "$stage" "passed" "v129 commercial order/access closure proofs"
}

run_v129_release_certification_gate() {
  local stage="release.v129-release-certification"
  local gate_run_id_for_cert="${GATE_RUN_ID:-local-workflow-run}"
  record_stage "$stage" "started" "$V129_RELEASE_CERTIFICATION_PATH"
  ...
  python3 - \
    ...
    "$SOURCE_COMMIT_SHA" \
    "$REQUIRE_PUBLISHED_RELEASE_FACTS" \
    "$V129_RELEASE_CERTIFICATION_PATH" \
    "$RUNTIME_DIR/release-provenance.json" \
    "$RUNTIME_DIR/release-facts.json" \
    "$RUNTIME_DIR/release-tag-proof.json" \
    "$RUNTIME_DIR/remote-release-proof.json" \
...
docs_readme = (root / "docs/README.md").read_text(encoding="utf-8")
delivery_readme = (root / "docs/delivery/README.md").read_text(encoding="utf-8")
release_readme = (root / "docs/delivery/releases/v1.2.9/README.md").read_text(encoding="utf-8")
release_tasks = (root / "docs/delivery/releases/v1.2.9/AGENTFLOW_V1_2_9_PAID_REPORT_COMMERCIAL_ORDER_ACCESS_CLOSURE_TASKS_V1.md").read_text(encoding="utf-8")
runtime_api = (root / "crates/runtime-api/src/commercial.rs").read_text(encoding="utf-8")
...
checks = {
    "release-version-is-v129": release_version == "v1.2.9" and release_tag == "v1.2.9",
    "workspace-version-is-v129": cargo_version == "1.2.9",
    "cargo-lock-agentflow-packages-are-v129": all(
        package.get("version") == "1.2.9"
        for package in cargo_lock.get("package", [])
        if str(package.get("name", "")).startswith("agentflow-")
    ),
    "desktop-package-version-is-v129": package_json.get("version") == "1.2.9",
    "desktop-lock-version-is-v129": package_lock.get("version") == "1.2.9"
        and package_lock.get("packages", {}).get("", {}).get("version") == "1.2.9",
    "tauri-version-is-v129": tauri.get("version") == "1.2.9",
    ...
    "admission-proof": proofs["v129-order-to-run-admission-gate.json"].get("coverage", {}).get("acceptedAdmissionLinksAllFacts") is True,
    "customer-access-proof": proofs["v129-customer-delivery-access-projection.json"].get("coverage", {}).get("projectionIsReadOnly") is True,
    "access-receipt-proof": proofs["v129-report-download-token-access-receipt.json"].get("coverage", {}).get("expiredOrRevokedBlockedWithReason") is True,
...
payload = {
    "version": "agentflow-v129-release-certification.v1",
    "status": "passed" if not failed else "failed",
    "certificationKind": certification_kind,
    "releaseVersion": release_version,
    "releaseTag": release_tag,
    ...
    "negativeFixtureSummary": {
        "fixtureCount": len(proofs["v129-commercial-negative-fixtures.json"].get("fixtures", [])),
        "allFixturesHaveReasonCodes": checks["negative-fixture-proof"],
    },
    "coverage": checks,
    "failedCoverage": failed,
    "payload": {
        "releaseScope": "v1.2.9",
        "primary": True,
        "issueRefs": [f"#{issue}" for issue in range(979, 989)],
        "proofPaths": primary_proofs,
        "certifiedBoundary": "paid report commercial order and access closure",
        "publicCommercialLaunch": False,
        "realPaidReportGeneration": False,
        "paymentProviderIntegration": False,
        "concretePaidReportSku": False,
...
out_path.write_text(json.dumps(payload, ensure_ascii=False, indent=2) + "\n", encoding="utf-8")
if failed:
    raise SystemExit(f"v129 release certification failed: {failed}")
PY
