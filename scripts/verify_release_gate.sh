...
def version_at_or_after(value, minimum):
    parsed_value = parse_version(value)
    parsed_minimum = parse_version(minimum)
    return parsed_value is not None and parsed_minimum is not None and parsed_value >= parsed_minimum
...
coverage = {
    "release-version-at-or-after-v109": version_at_or_after(release_version, expected_tag),
    "release-tag-at-or-after-v109": version_at_or_after(release_tag_name, expected_tag),
    "cargo-workspace-version-at-or-after-109": version_at_or_after(cargo["workspace"]["package"]["version"], expected_version),
    "desktop-package-version-at-or-after-109": version_at_or_after(desktop_package.get("version"), expected_version),
    "desktop-package-lock-version-at-or-after-109": version_at_or_after(desktop_package_lock.get("version"), expected_version)
    and version_at_or_after((desktop_package_lock.get("packages") or {}).get("", {}).get("version"), expected_version),
...
checks = {
    "release-version-is-v129": version_at_or_after(release_version, "v1.2.9") and version_at_or_after(release_tag, "v1.2.9"),
    "workspace-version-is-v129": version_at_or_after(cargo_version, "1.2.9"),
    "cargo-lock-agentflow-packages-are-v129": all(
        version_at_or_after(package.get("version"), "1.2.9")
        for package in cargo_lock.get("package", [])
        if str(package.get("name", "")).startswith("agentflow-")
    ),
    "desktop-package-version-is-v129": version_at_or_after(package_json.get("version"), "1.2.9"),
    "desktop-lock-version-is-v129": version_at_or_after(package_lock.get("version"), "1.2.9")
